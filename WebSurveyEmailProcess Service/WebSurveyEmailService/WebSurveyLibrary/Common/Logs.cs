...
namespace WebSurveyLibrary.Common
{
    public static class Logs
    {
        ...
        public static NLog.LogLevel ToNLogLogLevel(this WebSurveyLibrary.Common.LogLevel level)
        {
            NLog.LogLevel nloglevel = null;
            switch (level)
            {
                case WebSurveyLibrary.Common.LogLevel.Debug:
                    nloglevel = NLog.LogLevel.Debug;
                    break;
                case WebSurveyLibrary.Common.LogLevel.Error:
                    nloglevel = NLog.LogLevel.Error;
                    break;
                case WebSurveyLibrary.Common.LogLevel.Fatal:
                    nloglevel = NLog.LogLevel.Fatal;
                    break;
                case WebSurveyLibrary.Common.LogLevel.Info:
                    nloglevel = NLog.LogLevel.Info;
                    break;
                case WebSurveyLibrary.Common.LogLevel.Off:
                    nloglevel = NLog.LogLevel.Off;
                    break;
                case WebSurveyLibrary.Common.LogLevel.Trace:
                    nloglevel = NLog.LogLevel.Trace;
                    break;
                case WebSurveyLibrary.Common.LogLevel.Warn:
