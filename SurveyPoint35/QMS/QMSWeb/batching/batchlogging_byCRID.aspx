<%@ Page Language="vb" AutoEventWireup="false" Codebehind="batchlogging_byCRID.aspx.vb" Inherits="QMSWeb.frmBatchLoggingByCRID" smartNavigation="False" %>
							...
							<tr>
								<td rowspan="2" bgcolor="#d7d7c3">
									<table border="0" cellspacing="0" cellpadding="1">
										<tr>
											<td NOWRAP class="pagetitle"><!-- PAGE TITLE --> &nbsp;Batch Surveys</td>
										</tr>
									</table>
								</td>
											...
											<td> <!-- SEARCH FORM AND FIELDS GO IN AN INNER TABLE HERE-->
												...
												<table border="0" cellspacing="0" cellpadding="5" width="100%">
													...
													<TR>
														...
														<td width="50%"><asp:button id="btnSubmit" runat="server" Text="Batch" ToolTip="Click to view respondent details"
