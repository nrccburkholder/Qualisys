...
Public Class MainForm
    ...
    Private mServiceTesterNavigator As ServiceTesterNavigator
    Private mServiceTesterSection As ServiceTesterSection
    ...
    Private Sub InitializeUI()
        ...
        mServiceTesterNavigator = New ServiceTesterNavigator
        mServiceTesterSection = New ServiceTesterSection
        mUIRelations.Add(Me.tabServiceTester, New UIRelation(mServiceTesterNavigator, mServiceTesterSection))
        'Else
