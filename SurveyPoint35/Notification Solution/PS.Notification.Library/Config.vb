...
#Region " Custom Configuration Properties "
    ...
    Public Shared ReadOnly Property NrcAuthConnection() As String
        ...
        End Get
    End Property
    Public Shared ReadOnly Property EmailLANPath() As String
        Get
            Return CurrentEnvironment.Settings("EmailLANPath").Value
        End Get
    End Property
    ...
    Public Shared ReadOnly Property ApplicationName() As String
        Get
            Return Settings.GlobalSettings("ApplicationName").Value
        End Get
    End Property    
#End Region
