...
Module DatabaseHelper
    ...
    Friend ReadOnly Property Db(ByVal connString As String) As Database
        Get
            If mDBInstance Is Nothing Then
                mDBInstance = New Sql.SqlDatabase(connString)
            ElseIf mDBInstance.ConnectionString <> connString Then
                mDBInstance = Nothing
                mDBInstance = New Sql.SqlDatabase(connString)
            End If
            Return mDBInstance
    ...
    End Property
    ''' <summary>
    ''' This method overload assumes that the DB connection has already been set.
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
...
#Region " Helper Functions "
    ...
    Friend Function PopulateCollection(Of C As {BusinessListBase(Of T), New}, _
