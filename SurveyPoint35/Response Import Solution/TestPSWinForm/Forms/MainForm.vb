...
Public Class MainForm
    ...
    Private mDemoNavigator As DemoNavigator
    Private mDemoSection As DemoSection    
    ...
    Sub New()
        ...
        Me.spltMainPanel.SplitterDistance = My.Settings.MainFormSplitterLocation
    End Sub
    Private Sub InitializeUI()
        ...
        mDemoNavigator = New DemoNavigator
        mDemoSection = New DemoSection
        mUIRelations.Add(Me.DemoTab, New UIRelation(mDemoNavigator, mDemoSection))
        'Else
    ...
    Private Sub MultiPane_SelectedTabChanged(ByVal sender As Object, ByVal e As PS.Framework.WinForms.SelectedTabChangedEventArgs) Handles MultiPane.SelectedTabChanged
        ...
        Else
            ...
            Me.spltMainPanel.Panel2.Controls.Clear()
        End If
    ...
    Private Sub ActivateTab(ByVal oldTab As PS.Framework.WinForms.MultiPaneTab, ByVal newTab As PS.Framework.WinForms.MultiPaneTab)
        ...
        Try
            ...
            Me.spltMainPanel.Panel2.Controls.Add(sectionCtrl)
    ...
    Private Sub MainForm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        My.Settings.MainFormSplitterLocation = Me.spltMainPanel.SplitterDistance
