...
#Region " Private Methods "
            ...
            Using mail As New MailMessage
                Using attach As New Attachment(mImagePath)
                    ...
                    For Each addr As String In mReportRecipient.Split(New String() {",", ";"}, StringSplitOptions.RemoveEmptyEntries)
                        mail.To.Add(addr)
                    Next
                    mail.From = New MailAddress(mReportSender)
        ...
        Private Function GetExceptionHtml() As String
            ...
            'Dim inExcptionMessage As String = ""
            ...
            If TypeOf mException Is PS.Framework.Data.SqlCommandException Then
                sb.AppendFormat("<TR><TD Class=""LabelCell"">SQL Command:</TD><TD Class=""DataCell"">{0}</TD></TR>", DirectCast(mException, PS.Framework.Data.SqlCommandException).CommandText)
            End If
...
#Region " Windows Form Designer generated code "
            ...
            <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
                Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager("PS.Framework.WinForms.ExceptionReport", System.Reflection.Assembly.GetCallingAssembly)
...
#End Region
            ...
            Private Sub LoadExceptionMessage()
                mIsSqlCommandException = (TypeOf mException Is PS.Framework.Data.SqlCommandException)
                Me.Caption = mTitle
                ...
                If mIsSqlCommandException Then
                    txtSqlCommand.Text = DirectCast(mException, PS.Framework.Data.SqlCommandException).CommandText
                End If
            End Sub
