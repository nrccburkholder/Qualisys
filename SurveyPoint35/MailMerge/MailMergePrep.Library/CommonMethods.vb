...
Public Class CommonMethods
    ...
    End Function
    Public Shared Function DeserializeXMLDataset(ByVal filePath As String) As DataTable
        Dim dt As New DataTable("Results")
        If File.Exists(filePath) Then
            Dim streamReader As StreamReader = Nothing
            Try
                streamReader = New StreamReader(filePath)
                Dim xmlSerial As New XmlSerializer(dt.GetType())
                dt = xmlSerial.Deserialize(streamReader)
            Finally
