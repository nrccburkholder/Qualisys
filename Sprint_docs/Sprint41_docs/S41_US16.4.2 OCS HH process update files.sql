...
if exists (select * from sys.procedures where name = 'UpdateOCSEncounterData_Qualisys' and schema_id = SCHEMA_ID('dbo'))
	drop procedure dbo.UpdateOCSEncounterData_Qualisys;
go
create proc [dbo].[UpdateOCSEncounterData_Qualisys]
	@datafile_id int
as
