...
if not exists (select 1 from sys.columns where Name = 'ICD10_1' and object_id = OBJECT_ID('ExportFileHHCAHPSDetails'))
	alter table dbo.ExportFileHHCAHPSDetails add
		ICD10_1 varchar(10) null,
		ICD10_2 varchar(10) null,
		ICD10_3 varchar(10) null,
		ICD10_4 varchar(10) null,
		ICD10_5 varchar(10) null,
		ICD10_6 varchar(10) null
go
...
DECLARE @ICD9Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD9')
BEGIN
	if @indebug = 1 print 'ICD9 field exists'
	set @ICD9Field = 'ICD9 as ICD9'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD9 field does not exist'
	set @ICD9Field =  'Null as ICD9'
END

DECLARE @ICD9_2Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD9_2')
BEGIN
	if @indebug = 1 print 'ICD9_2 field exists'
	set @ICD9_2Field = 'ICD9_2 as ICD9_2'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD9_2 field does not exist'
	set @ICD9_2Field =  'Null as ICD9_2'
END

DECLARE @ICD9_3Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD9_3')
BEGIN
	if @indebug = 1 print 'ICD9_3 field exists'
	set @ICD9_3Field = 'ICD9_3 as ICD9_3'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD9_3 field does not exist'
	set @ICD9_3Field =  'Null as ICD9_3'
END

DECLARE @ICD9_4Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD9_4')
BEGIN
	if @indebug = 1 print 'ICD9_4 field exists'
	set @ICD9_4Field = 'ICD9_4 as ICD9_4'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD9_4 field does not exist'
	set @ICD9_4Field =  'Null as ICD9_4'
END

DECLARE @ICD9_5Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD9_5')
BEGIN
	if @indebug = 1 print 'ICD9_5 field exists'
	set @ICD9_5Field = 'ICD9_5 as ICD9_5'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD9_5 field does not exist'
	set @ICD9_5Field =  'Null as ICD9_5'
END

DECLARE @ICD9_6Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD9_6')
BEGIN
	if @indebug = 1 print 'ICD9_6 field exists'
	set @ICD9_6Field = 'ICD9_6 as ICD9_6'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD9_6 field does not exist'
	set @ICD9_6Field =  'Null as ICD9_6'
END

DECLARE @ICD10_1Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD10_1')
BEGIN
	if @indebug = 1 print 'ICD10_1 field exists'
	set @ICD10_1Field = 'ICD10_1 as ICD10_1'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD10_1 field does not exist'
	set @ICD10_1Field =  'Null as ICD10_1'
END

DECLARE @ICD10_2Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD10_2')
BEGIN
	if @indebug = 1 print 'ICD10_2 field exists'
	set @ICD10_2Field = 'ICD10_2 as ICD10_2'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD10_2 field does not exist'
	set @ICD10_2Field =  'Null as ICD10_2'
END

DECLARE @ICD10_3Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD10_3')
BEGIN
	if @indebug = 1 print 'ICD10_3 field exists'
	set @ICD10_3Field = 'ICD10_3 as ICD10_3'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD10_3 field does not exist'
	set @ICD10_3Field =  'Null as ICD10_3'
END

DECLARE @ICD10_4Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD10_4')
BEGIN
	if @indebug = 1 print 'ICD10_4 field exists'
	set @ICD10_4Field = 'ICD10_4 as ICD10_4'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD10_4 field does not exist'
	set @ICD10_4Field =  'Null as ICD10_4'
END

DECLARE @ICD10_5Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD10_5')
BEGIN
	if @indebug = 1 print 'ICD10_5 field exists'
	set @ICD10_5Field = 'ICD10_5 as ICD10_5'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD10_5 field does not exist'
	set @ICD10_5Field =  'Null as ICD10_5'
END

DECLARE @ICD10_6Field varchar(100)
IF exists (select 'x' from information_schema.columns where table_schema = 's'+@study_ID  and table_name = 'Big_table_view' and column_name = 'ICD10_6')
BEGIN
	if @indebug = 1 print 'ICD10_6 field exists'
	set @ICD10_6Field = 'ICD10_6 as ICD10_6'
END
ELSE
BEGIN
	if @indebug = 1 print 'ICD10_6 field does not exist'
	set @ICD10_6Field =  'Null as ICD10_6'
END

DECLARE @ICDSelectList varchar(1000)
set @ICDSelectList = 
	@ICD9Field + ', ' + @ICD9_2Field + ', ' + @ICD9_3Field + ', ' + @ICD9_4Field + ', ' + @ICD9_5Field + ', ' + @ICD9_6Field + ', ' +
	@ICD10_1Field + ', ' + @ICD10_2Field + ', ' + @ICD10_3Field + ', ' + @ICD10_4Field + ', ' + @ICD10_5Field + ', ' + @ICD10_6Field
   ...
   ExportFileGUID,SmpEncDt,SampPop,Rtrn_dt,Method,HHCatAge,HHVisCt,HHLBCt,HHAdmHsp,HHAdmRhb,HHAdmSNF,            
     ...
     ICD9_3,ICD9_4,ICD9_5,ICD9_6,ICD10_1,ICD10_2,ICD10_3,ICD10_4,ICD10_5,ICD10_6,
	 HHSurg,HHESRD,HHADLDef,HHADLDUp,HHADLDLo,HHADLBth,HHADLToi,HHADLTrn,            
     ...
     HHAdmLTC,HHAdmOIP,HHAdmCom,HHPayMcr,HHPayMcd,HHPayIns,HHPayOth,HHHMO,HHDual,' +
	 @ICDSelectList + ',' +
	 'HHSurg,HHESRD,HHADLDef,HHADLDUp,HHADLDLo,HHADLBth,HHADLToi,HHADLTrn,            
