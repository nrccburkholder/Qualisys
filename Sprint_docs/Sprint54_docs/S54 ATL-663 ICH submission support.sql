/*
S54 ATL-662 ICH Submission Support
ATL-663 Fix issues and pull files

alter procedure etl_ProcessSamplePopulationDispositionLogRecords
*/
use NRC_Datamart
go
...
AS 
-- =============================================
--	S20 US15	 3/12/2015 T.Butler  As an authorized Hospice CAHPS vendor, we need to assign the dispo "Ineligible - Never Involved in Care" if the respondent answers Q3 "Never".
--  S46 US7.1	 3/31/2016 T.Butler Specify applicable receipt type in dispo override for ICH
-- =============================================
BEGIN
   ...
   --SET @DataFileID = 16
    ...
    INTO #temp
    FROM LOAD_TABLES.SamplePopulationDispositionLog lt WITH (NOLOCK)
      INNER JOIN CahpsDispositionMapping mapping WITH (NOLOCK) ON lt.CahpsTypeID = mapping.CahpsTypeID  AND lt.DispositionID = mapping.DispositionID AND CASE WHEN Mapping.ReceiptTypeID = -1 THEN -1 ELSE lt.ReceiptTypeID END = Mapping.ReceiptTypeID    
	...
	begin
		...
		insert into @eligibilityOverride values (-9,2,0,1,32,5130,17)	-- [blank] (-9) / No longer at this facility (5)				--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,3,0,1,32,5130,17)	-- [blank] (-9) / No longer at this facility (5)				--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,4,0,1,32,5130,17)	-- [blank] (-9) / No longer at this facility (5)				--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,5,0,1,34,5190,NULL)	-- [blank] (-9) / No longer at this facility (5)				--> Ineligible: No Longer Receiving Care at Sampled Facility
		insert into @eligibilityOverride values (1,-9,0,1,8,5160,NULL)	-- At home (1) / [blank] (-9)									--> Ineligible: Does Not Meet Eligibility Criteria
		insert into @eligibilityOverride values (1,1,0,1,8,5160,NULL)	-- At home (1) / < 3 months (1)									--> Ineligible: Does Not Meet Eligibility Criteria
		insert into @eligibilityOverride values (1,2,0,1,32,5130,17)	-- At home (1) / 3-12 months (2)								--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,3,0,1,32,5130,17)	-- At home (1) / 1-5 years (3)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,4,0,1,32,5130,17)	-- At home (1) / 5 years + (4)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,5,0,1,34,5190,NULL)	-- At home (1) / No longer at this facility (5)					--> Ineligible: No Longer Receiving Care at Sampled Facility
																		-- At the dialysis ctr (2) / [blank] (-9)						--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (2,1,0,1,8,5160,NULL)	-- At the dialysis ctr (2) / < 3 months (1)						--> Ineligible: Does Not Meet Eligibility Criteria
																		-- At the dialysis ctr (2) / 3 months+ (2-4*)					--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (2,5,0,1,34,5190,NULL)	-- At the dialysis ctr (2) / No longer at this facility (5)		--> Ineligible: No Longer Receiving Care at Sampled Facility
		insert into @eligibilityOverride values (3,-9,0,1,33,5140,NULL)	-- Do not currently rec'v (3) / [blank] (-9)					--> Ineligible: Not Receiving Dialysis
		insert into @eligibilityOverride values (3,1,0,1,33,5140,NULL)	-- Do not currently rec'v (3) / < 3 months (1)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,2,0,1,32,5130,17)	-- Do not currently rec'v (3) / 3-12 months (2)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,3,0,1,32,5130,17)	-- Do not currently rec'v (3) / 1-5 years (3)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,4,0,1,32,5130,17)	-- Do not currently rec'v (3) / 5 years+ (4)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,5,0,1,33,5140,NULL)	-- Do not currently rec'v (3) / No longer at this facility (5)	--> Ineligible: Not Receiving Dialysis
				
		insert into @eligibilityOverride values (-9,-9,1,1,32,5130,17)	-- [blank] (-9) / [blank] (-9)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,1,1,1,32,5130,17)	-- [blank] (-9) / < 3 months (1)								--> Completed Mail Questionnaire—Survey Eligibility Unknown
																		-- [blank] (-9) / 3 months+ (2-4*)								--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (-9,2,1,1,32,5130,17)	-- [blank] (-9) / No longer at this facility (5)				--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,3,1,1,32,5130,17)	-- [blank] (-9) / No longer at this facility (5)				--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,4,1,1,32,5130,17)	-- [blank] (-9) / No longer at this facility (5)				--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,5,1,1,32,5130,17)	-- [blank] (-9) / No longer at this facility (5)				--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,-9,1,1,32,5130,17)	-- At home (1) / [blank] (-9)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,1,1,1,32,5130,17)	-- At home (1) / < 3 months (1)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,2,1,1,32,5130,17)	-- At home (1) / 3-12 months (2)								--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,3,1,1,32,5130,17)	-- At home (1) / 1-5 years (3)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,4,1,1,32,5130,17)	-- At home (1) / 5 years+ (4)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,5,1,1,32,5130,17)	-- At home (1) / No longer at this facility (5)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
																		-- At the dialysis ctr (2) / [blank] (-9)						--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (2,1,1,1,32,5130,17)	-- At the dialysis ctr (2) / < 3 months (1)						--> Completed Mail Questionnaire—Survey Eligibility Unknown
																		-- At the dialysis ctr (2) / 3 months+ (2-4*)					--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (2,5,1,1,32,5130,17)	-- At the dialysis ctr (2) / No longer at this facility (5)		--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (2,-9,1,1,32,5130,17)	-- Do not currently rec'v (3) / [blank] (-9)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,-9,1,1,32,5130,17)	-- Do not currently rec'v (3) / [blank] (-9)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,1,1,1,32,5130,17)	-- Do not currently rec'v (3) / < 3 months (1)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,2,1,1,32,5130,17)	-- Do not currently rec'v (3) / 3-12 months (2)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,3,1,1,32,5130,17)	-- Do not currently rec'v (3) / 1-5 years (3)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,4,1,1,32,5130,17)	-- Do not currently rec'v (3) / 5 years+ (4)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,5,1,1,32,5130,17)	-- Do not currently rec'v (3) / No longer at this facility (5)	--> Completed Mail Questionnaire—Survey Eligibility Unknown
		...
		from (select qf.ReceiptTypeID, qf.samplepopulationid
				, max(	case when masterquestioncore =51198 then 
							case when responsevalue < 0 then -9 else responsevalue % 10000 end -- recode anything less than zero to -9, and mod 10000 so it'll join with @eligibilityOverride 
						else 
							-9 
						end) as Q1
			...
			group by qf.ReceiptTypeID,qf.samplepopulationid) r
		inner join @eligibilityOverride eo on r.q1=eo.q1 and r.q2=eo.q2 and r.Q3to44Answers=eo.Q3to44Answers and r.AnyAnswers=eo.AnyAnswers and (eo.ReceiptTypeID is null or eo.ReceiptTypeID = r.ReceiptTypeID)
	...
	/* begin S20 US15 */
	if exists (select * from #temp where CahpsTypeID=6) --  Hospice CAHPS
	begin

		declare @eligibilityOverrideHospice table (Q3 int, DispositionOverride int, CahpsDispositionOverride int)
		insert into @eligibilityOverrideHospice values (1,45,606)	-- NEVER (1) 					--> Ineligible: Never Involved in Decedent Care
		
		declare @overrideHospice table (SamplepopulationID int, DispositionOverride int, CahpsDispositionOverride int)

		insert into @overrideHospice
		select SamplepopulationID, DispositionOverride, CahpsDispositionOverride
		from (select qf.samplepopulationid
				, max(	case when rb.masterquestioncore =51576 then 
			...
			inner join load_tables.questionform qf on t.SamplePopulationID=qf.SamplePopulationID	
			inner join load_tables.responsebubble rb on rb.QuestionFormID=qf.QuestionFormID
			where t.CahpsTypeID=6
			group by qf.samplepopulationid) r
		inner join @eligibilityOverrideHospice eo on r.q3=eo.q3

		
		update t set CahpsDispositionID=o.CahpsDispositionOverride, DispositionID=o.DispositionOverride, CahpsHierarchy=0
		--select o.samplepopulationid, t.CahpsDispositionID, o.CahpsDispositionOverride, t.DispositionID, o.DispositionOverride, t.CahpsHierarchy, 0
		from @overrideHospice o
		inner join #temp t on o.samplepopulationid=t.samplepopulationid
