/*
RTP-3220 MakeTemplateFromSurveys.sql

Chris Burkholder

6/13/2017

CREATE PROCEDURE [RTPhoenix].[MakeTemplateFromGoldenStudy]

*/
USE [QP_Prod]
GO

IF OBJECT_ID('RTPhoenix.MakeTemplateFromGoldenStudy', 'P') IS NOT NULL
DROP PROC [RTPhoenix].[MakeTemplateFromGoldenStudy]
GO
...
INSERT INTO [RTPhoenix].[SAMPLEPLANTemplate]
           ...
           ,[SURVEY_ID]
           ,[DATCREATE_DT]
           ,[_STRSAMPLEUNIT_NM_ROOT])
SELECT sp.[SAMPLEPLAN_ID]
      ,[ROOTSAMPLEUNIT_ID]
      ,[EMPLOYEE_ID]
      ,sp.[SURVEY_ID]
      ,[DATCREATE_DT]
      ,sur.[STRSAMPLEUNIT_NM]
