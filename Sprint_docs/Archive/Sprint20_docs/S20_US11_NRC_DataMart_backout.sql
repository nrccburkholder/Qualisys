...
if exists (	SELECT 1 
	...
	alter table [dbo].[SampleSet] drop column SamplingMethodID
...
if exists (	SELECT 1 
	...
	alter table [LOAD_TABLES].[SampleSet] drop column SamplingMethodID
...
if exists (	SELECT 1 
	...
	alter table [LOAD_TABLES].[SampleSetError] drop column SamplingMethodID
