/*
	...
	alter table [dbo].[USPS_ACS_ExtractFile_Work] drop column MoveType varchar(1) 
...
if exists (	SELECT 1 
	...
	alter table [dbo].[USPS_ACS_ExtractFile_Work] drop column MoveType 
...
USE [QP_Prod]
GO
/****** Object:  StoredProcedure [dbo].[USPS_ACS_InsertExtractFileRecord]    Script Date: 6/25/2015 9:27:38 AM ******/
SET ANSI_NULLS ON
GO
...
USE [QP_Prod]
GO
/****** Object:  StoredProcedure [dbo].[USPS_ACS_ProcessFile]    Script Date: 6/25/2015 9:28:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
