...
--if not exists (select * from CAHPSDisposition where CahpsTypeID=9)
	...
	SELECT N'9110', /*110,*/	9,'Completed Mail Survey',1,0 UNION ALL
	SELECT N'9120', /*120,*/	9,'Completed Phone Interview',1,0 UNION ALL
	SELECT N'9210', /*210,*/	9,'Ineligible: Deceased',0,0 UNION ALL
	SELECT N'9220', /*220,*/	9,'Ineligible: Does not meet eligible Population criteria',0,0 UNION ALL
	SELECT N'9230', /*230,*/	9,'Ineligible: Language Barrier',0,0 UNION ALL
	SELECT N'9240', /*240,*/	9,'Ineligible: Mentally or Physically Incapacitated/No Proxy Available',0,0 UNION ALL
	SELECT N'9310', /*310,*/	9,'Breakoff',0,1 UNION ALL
--	SELECT N'9320', /*320,*/	9,'Blank second mail survey',0,0 UNION ALL
	SELECT N'9320', /*320,*/	9,'Refusal',0,0 UNION ALL
	SELECT N'9330', /*330,*/	9,'Bad Address/Undeliverable Mail',0,0 UNION ALL
	SELECT N'9340', /*340,*/	9,'Wrong, Disconnected or No Telephone Number',0,0 UNION ALL
--	SELECT N'9350', /*350,*/	9,'Blank first mail survey',0,0 UNION ALL
--	SELECT N'9350', /*350,*/	9,'Breakoff is actually blank',0,0 UNION ALL
	SELECT N'9350', /*350,*/	9,'No Response After Maximum Attempts',0,0 
	order by 1
...
--if not exists (select * from CahpsDispositionMapping where CahpsTypeID=9)
	...
	Select 9,8,-1,'Ineligible: Does not meet eligible Population criteria',9220,/*220,*/1,0 union all
	Select 9,3,-1,'Ineligible: Deceased',9210,/*210,*/2,0 union all
	Select 9,4,-1,'Ineligible: Mentally or Physically Incapacitated/No Proxy Available',9240,/*240,*/3,0 union all
	Select 9,10,-1,'Ineligible: Language Barrier',9230,/*230,*/4,0 union all
	Select 9,26,-1,'Blank second mail survey',9320,/*320,*/5,0 union all
	Select 9,2,-1,'Refusal',9320,/*320,*/5,0 union all
	Select 9,19,17,'Completed Mail Survey',9110,/*110,*/6,0 union all
	Select 9,20,12,'Completed Phone Interview',9120,/*120,*/6,0 union all
	Select 9,49,-1,'Breakoff is actually blank',9350,/*350,*/7,0 union all
	Select 9,11,-1,'Breakoff',9310,/*310,*/8,0 union all
	Select 9,14,-1,'Wrong, Disconnected or No Telephone Number',9340,/*340,*/9,0 union all
	Select 9,16,-1,'Wrong, Disconnected or No Telephone Number',9340,/*340,*/9,0 union all
	Select 9,5,-1,'Bad Address/Undeliverable Mail',9330,/*330,*/10,0 union all
	Select 9,12,-1,'No Response After Maximum Attempts',9350,/*350,*/11,1 union all
	Select 9,25,-1,'Blank first mail survey',9350,/*350,*/11,0
