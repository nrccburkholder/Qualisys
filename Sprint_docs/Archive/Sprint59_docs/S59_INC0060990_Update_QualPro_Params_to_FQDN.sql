...
S59_INC0060990_Update_QualPro_Params_to_FQDN.sql
...
update qpp set strparam_value = replace(strparam_value, @old, @new)
--select strparam_value, replace(strparam_value, @old, @new), len(replace(strparam_value, @old, @new))
