...
Tim Butler
	...
	alter table [dbo].[SamplePopulation] add columns NumberOfMailAttempts, NumberOfPhoneAttempts
	alter table [dbo].[SamplePopulationError] add columns NumberOfMailAttempts, NumberOfPhoneAttempts
	alter table [dbo].[SamplePopulationNPIError] add columns NumberOfMailAttempts, NumberOfPhoneAttempts
	alter table [LOAD_TABLES].[SamplePopulation] add columns NumberOfMailAttempts, NumberOfPhoneAttempts
...
if not exists (	SELECT 1 
	...
	alter table [dbo].[SamplePopulation] add NumberOfMailAttempts int NULL 
...
if not exists (	SELECT 1 
	...
	alter table [dbo].[SamplePopulation] add NumberOfPhoneAttempts int NULL 
...
if not exists (	SELECT 1 
	...
	alter table [LOAD_TABLES].[SamplePopulation] add NumberOfMailAttempts int NULL
...
if not exists (	SELECT 1 
	...
	alter table [LOAD_TABLES].[SamplePopulation] add NumberOfPhoneAttempts int NULL
...
if not exists (	SELECT 1 
	...
	alter table [LOAD_TABLES].[SamplePopulationError] add NumberOfMailAttempts int NULL
...
if not exists (	SELECT 1 
	...
	alter table [LOAD_TABLES].[SamplePopulationError] add NumberOfPhoneAttempts int NULL
...
if not exists (	SELECT 1 
	...
	alter table [LOAD_TABLES].[SamplePopulationNPIError] add NumberOfMailAttempts int NULL
...
if not exists (	SELECT 1 
	...
	alter table [LOAD_TABLES].[SamplePopulationNPIError] add NumberOfPhoneAttempts int NULL
...
--			3.0  Tim Butler - S28 US31 Add NumberOfMailAttempts and NumberOfPhoneAttempts columns
-- =============================================
BEGIN
		...
		*/
		...
		BEGIN TRANSACTION
			...
			SET SampleSetID = lt.SampleSetID
				...
				,NumberOfMailAttempts = lt.NumberOfMailAttempts --S28 US31
				,NumberOfPhoneAttempts = lt.NumberOfPhoneAttempts --S28 US31
			FROM LOAD_TABLES.SamplePopulation lt WITH (NOLOCK)
