/*
	...
	S43 US 6 Production incidents
	Add a new task for each incident
...
USE [QP_Prod]
GO
/****** Object:  StoredProcedure [dbo].[QCL_SampleSetResurveyExclusion_StaticPlus]  Script Date: 2/26/2016 4:06:24 AM ******/
SET ANSI_NULLS ON
GO
