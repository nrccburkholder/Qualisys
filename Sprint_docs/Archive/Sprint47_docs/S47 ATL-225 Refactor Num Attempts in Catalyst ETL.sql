/*
	S47 ATL-225 Refactor Num Attempts in Catalyst ETL_Rollback
	
	ATL-225 As the Atlas Team, we want to review the code in the Cat ETL for Hospice Num Attempts & generalize so it can be applied to other survey types
