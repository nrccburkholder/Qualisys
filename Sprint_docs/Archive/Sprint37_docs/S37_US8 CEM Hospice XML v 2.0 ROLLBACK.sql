...
select @newTemplateID=exporttemplateid from cem.exporttemplate where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='2.0' and ExportTemplateVersionMinor=1
...
and type = 'P' AND name = 'ExportPostProcess00000008')
DROP PROCEDURE [CEM].[ExportPostProcess00000008]
