/*
S9.US8	HCAHPS Blank Survey Dispo
		As an Authorized Vendor, we want to correctly disposition blank surveys, so that we report correct data

T8.1	Analize and fix the remaining issues in processing blank returns for HCAHPS
