...
if not exists (select * from cem.ExportTemplate_view where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='1.3' and ExportTemplateVersionMinor=1 and ExportColumnName='survey-mode' and recodevalue='8')
	...
	and ExportTemplateID = (select ExportTemplateID from cem.ExportTemplate where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='1.3' and ExportTemplateVersionMinor=1)
...
if not exists (select * from cem.ExportTemplate_view where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='1.3' and ExportTemplateVersionMinor=1 and ExportColumnName='sample-type' and recodevalue='8')
	insert into cem.ExportTemplateColumnResponse (ExportTemplateColumnID, RawValue, ExportColumnName, RecodeValue, ResponseLabel)
	select distinct ExportTemplateColumnID, 8, null, '8', 'not applicable (no decedents in the sampled month)'
	from cem.ExportTemplate_view 
...
if not exists (select * from cem.ExportTemplate_view where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='1.3' and ExportTemplateVersionMinor=1 and ExportColumnName='admission-yr' and RecodeValue='8888')
	update etcr 
...
if not exists (select * from cem.ExportTemplate_view where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='1.3' and ExportTemplateVersionMinor=1 and ExportColumnName='admission-yr' and RawValue between 0 and 2008)
	insert into cem.ExportTemplateColumnResponse (ExportTemplateColumnID, RawValue, ExportColumnName, RecodeValue, ResponseLabel)
...
if not exists (select * from cem.ExportTemplate_view where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='1.3' and ExportTemplateVersionMinor=1 and ExportColumnName='admission-month' and RecodeValue='88')
	insert into cem.ExportTemplateColumnResponse (ExportTemplateColumnID, RawValue, ExportColumnName, RecodeValue, ResponseLabel)
...
if not exists (select * from cem.ExportTemplate_view where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='1.3' and ExportTemplateVersionMinor=1 and ExportColumnName='admission-day' and RecodeValue='88')
	insert into cem.ExportTemplateColumnResponse (ExportTemplateColumnID, RawValue, ExportColumnName, RecodeValue, ResponseLabel)
	select distinct ExportTemplateColumnID, 0, null, '88', 'missing'
	from cem.ExportTemplate_view
...
if not exists (select * from cem.ExportTemplate_view where ExportTemplateName='CAHPS Hospice' and ExportTemplateVersionMajor='1.3' and ExportTemplateVersionMinor=1 and ExportColumnName='survey-status' and ResponseLabel = 'Non-response: Bad/No Address')
	update etcr 
