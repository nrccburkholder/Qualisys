/*
S11.US15 Update Mixed Mode Phone Vendor Notification
		As an approved vendor for ICH CAHPS and ACO CAHPS, we want to continue phone contact if we receive a blank survey from the mail phase of a mixed mode, so that we follow CAHPS guidelines

T15.1	An an additional code to QSL_PhoneVendorCancelLIst 
