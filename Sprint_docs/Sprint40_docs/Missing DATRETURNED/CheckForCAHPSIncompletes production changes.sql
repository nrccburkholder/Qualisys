<EVENT_INSTANCE>
  ...
  <PostTime>2015-02-24T15:14:18.460</PostTime>
  <SPID>65</SPID>
  <ServerName>NRC10</ServerName>
  <LoginName>NRC\dmayhew</LoginName>
  <UserName>dbo</UserName>
  <DatabaseName>QP_Prod</DatabaseName>
  <SchemaName>dbo</SchemaName>
  <ObjectName>CheckForCAHPSIncompletes</ObjectName>
  <ObjectType>PROCEDURE</ObjectType>
  <TSQLCommand>
    <SetOptions ANSI_NULLS="ON" ANSI_NULL_DEFAULT="ON" ANSI_PADDING="ON" QUOTED_IDENTIFIER="ON" ENCRYPTED="FALSE" />
    <CommandText>alter PROCEDURE [dbo].[CheckForCAHPSIncompletes]  
AS  
-- =============================================  
...
-- ACO Disposition 34 = blank/incomplete  
   ...
   ----, convert(datetime,null) as GenDate1st, convert(datetime,null)as GenDate2nd  
...
group by ae.MAILINGSTEP_ID,ae.SAMPLEPOP_ID,ae.METHODOLOGY_ID  </CommandText>
  </TSQLCommand>
</EVENT_INSTANCE>