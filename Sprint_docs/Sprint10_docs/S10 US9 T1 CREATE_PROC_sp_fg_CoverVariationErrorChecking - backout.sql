...
go
if exists (select * from FormGenErrorType where FGErrorType_id=41)
	delete from FormGenErrorType where FGErrorType_id=41
if  exists (select * from FormGenErrorType where FGErrorType_id=42)
	delete from FormGenErrorType where FGErrorType_id=42
if  exists (select * from FormGenErrorType where FGErrorType_id=43)
	delete from FormGenErrorType where FGErrorType_id=43
go
