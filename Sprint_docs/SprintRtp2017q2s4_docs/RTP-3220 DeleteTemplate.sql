/*
RTP-3220 DeleteTemplate.sql

Chris Burkholder

6/13/2017

CREATE PROCEDURE [RTPhoenix].[DeleteTemplate]

*/
USE [QP_Prod]
GO

IF OBJECT_ID('RTPhoenix.DeleteTemplate', 'P') IS NOT NULL
DROP PROC [RTPhoenix].[DeleteTemplate]
GO
