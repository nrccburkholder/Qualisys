/*
select * from sys.tables where schema_id=1643 order by create_date

select * from cihi.Submission
select * from cihi.SubmissionSurvey

select * from CIHI.Final_Metadata
select * from CIHI.Final_OrgProfile
select * from CIHI.Final_Contact
select * from CIHI.Final_Role
select * from CIHI.Final_QuestionnaireCycle
select * from CIHI.Final_Stratum
select * from CIHI.Final_Questionnaire
select * from CIHI.Final_Question

delete from CIHI.Final_Metadata where submissionid=1
delete from CIHI.Final_OrgProfile where submissionid=1
delete from CIHI.Final_Contact where submissionid=1
delete from CIHI.Final_Role where submissionid=1
delete from CIHI.Final_QuestionnaireCycle where submissionid=1
delete from CIHI.Final_Stratum where submissionid=1
delete from CIHI.Final_Questionnaire where submissionid=1
delete from CIHI.Final_Question where submissionid=1

select * from CIHI.OrgProfile
select * from CIHI.QA_QuestionnaireCycleAndStratum
select samplepopid from CIHI.QA_Questionnaire group by samplepopid having count(*)>1
select samplepopid, count(*) from CIHI.QA_Question group by samplepopid order by 2

delete from CIHI.QA_QuestionnaireCycleAndStratum where submissionid=1
delete from CIHI.QA_Questionnaire where submissionid=1
delete from CIHI.QA_Question  where submissionid=1
update cihi.submission set pulldate=null where submissionid=1
exec CIHI.PullSubmissionData 1
*/
use qp_prod
go
...
INSERT INTO CIHI.Final_Questionnaire 
	( [SubmissionID], [Final_QuestionnaireCycleID], [questionnaireCycle.questionnaire.id.value], [questionnaireCycle.questionnaire.subject.id.value], [questionnaireCycle.questionnaire.subject.id.issuer.code_code]
