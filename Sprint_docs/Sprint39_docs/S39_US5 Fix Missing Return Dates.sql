...
BEGIN
	...
	declare @host_name nvarchar(256), @program_name nvarchar(256), @login_name nvarchar(256)
	begin try
	...
	select getdate(), @host_name, @program_name, @login_name, d.QUESTIONFORM_ID, d.SENTMAIL_ID, d.SAMPLEPOP_ID, d.DATRETURNED, d.SURVEY_ID, d.UnusedReturn_id, d.datUnusedReturn, d.datResultsImported, d.strSTRBatchNumber, d.intSTRLineNumber, d.ReceiptType_id, d.strScanBatch
	from deleted d
