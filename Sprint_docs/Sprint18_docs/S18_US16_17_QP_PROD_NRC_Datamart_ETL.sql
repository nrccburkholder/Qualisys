...
/****** Object:  UserDefinedFunction [dbo].[FirstDayOfMonth]    Script Date: 2/17/2015 11:18:59 AM ******/
IF EXISTS (SELECT * FROM sys.objects where type IN (N'FN', N'IF', N'TF', N'FS', N'FT') and schema_id=1 and name = 'FirstDayOfMonth')
