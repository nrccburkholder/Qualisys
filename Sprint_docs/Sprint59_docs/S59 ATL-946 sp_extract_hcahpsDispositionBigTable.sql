    ...
    BEGIN
      ...
      EXEC (@sql)
              ...
              IF (EXISTS (SELECT *
                ...
                SET @SQL = 'UPDATE sd
							SET lagtime = datediff(dd, bt.dischargedate, isnull(srw.datReturned, sr.datreturned))
              ...
              ELSE
                SET @SQL = 'UPDATE sd
							SET lagtime = datediff(dd, bt.dischargedate, sr.datreturned)
              ...
              SET @SQL = @SQL
                         + ' join #SampDispo sd on bt.samplepop_id = sd.samplepop_id
							WHERE sd.lagtime = 0
