...
S52 ATL-192 HCAHPS Update File Dispositions

Tim Butler

As a Corporate Compliance Associate, I want HCAHPS update files loaded by the Data Management team to log new dispositions when necessary, so that we do not have to do this manually.

Specifically, we are seeing a high number of ineligible patients across all CCNs after these update files are applied. This means we need to disposition the patients 
as ineligible for the HCAHPS survey and prevent any response data from being submitted to CMS. There would be a couple different fields in the update that could 
potentially disqualify an HCAHPS patient (HSERVICETYPE, HDISCHARGESTATUS). I can provide further details when necessary.

Priority: Medium ? currently I am manually pulling a list of ineligible patients for Santosh to recode the disposition for
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES 
           WHERE TABLE_NAME = 'DRGUpdateDispositionMapping'
		   and TABLE_SCHEMA = 'dbo')
BEGIN
  DROP table dbo.DRGUpdateDispositionMapping
END



CREATE TABLE dbo.DRGUpdateDispositionMapping (
    DRGUpdateDispositionMapping_ID int IDENTITY(1,1) NOT NULL,
    FieldName VARCHAR(50) NOT NULL,
	UpdateValue VARCHAR(10) NOT NULL,
	Disposition_id [int] NOT NULL
    PRIMARY KEY (DRGUpdateDispositionMapping_ID)
); 
...
/* Populate DRGUpdateDispositionMapping */

USE [QP_Prod]
GO

	IF NOT EXISTS (SELECT 1 FROM [dbo].[DRGUpdateDispositionMapping])
	BEGIN
		begin tran
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HAdmissionSource','8',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HAdmissionSource','08',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','21',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','87',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','3',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','03',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','61',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','64',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','83',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','92',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','50',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','51',8)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','20',3)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','40',3)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','41',3)
			INSERT INTO [dbo].[DRGUpdateDispositionMapping]([FieldName],[UpdateValue],[Disposition_id]) VALUES('HDischargeStatus','42',3)
...
SELECT *
FROM [dbo].[DRGUpdateDispositionMapping]
...
USE [QP_Prod]
GO
/****** Object:  StoredProcedure [dbo].[LD_UpdateDRG_Updater]    Script Date: 6/23/2016 3:09:22 PM ******/
SET ANSI_NULLS ON
GO
...
-- Modified by TSB 06/24/2016: S52 ATL-192 HCAHPS Update file dispostions - modified to insert into DispositionLog for specific value updates on specified fields.  The                     
...
SET @Sql = 'INSERT #HCAHPSUpdateLog (samplepop_id, field_name, old_value, new_value, Change_Datee) ' +                       
...
WHERE ul.new_value <> ul.old_value
...
insert into DRGDebugLogging (Study_ID, DataFile_Id, Message) Select @study_ID, @DataFile_ID,  'INSERT DispositionLog Records Updated(1): ' + + LTRIM(STR(@myRowCount))   
