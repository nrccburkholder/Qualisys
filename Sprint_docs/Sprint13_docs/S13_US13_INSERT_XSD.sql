              ...
              <xs:element name="patientresponse" minOccurs="0" maxOccurs="1">
                <xs:complexType>
                  <xs:sequence>
                    ...
                    <xs:element name="race-noneofabove-phone" minOccurs="1"><xs:simpleType><xs:restriction base="xs:string"><xs:pattern value="[1mM]"/><xs:minLength value="1"/><xs:maxLength value="1"/></xs:restriction></xs:simpleType></xs:element>
