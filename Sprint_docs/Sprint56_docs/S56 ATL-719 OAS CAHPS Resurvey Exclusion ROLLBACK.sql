-- S56 ATL-719 OAS CAHPS Resurvey Exclusion ROLLBACK.sql
-- XiQualSQL02
USE [QP_Prod]
GO

/****** Object:  StoredProcedure [dbo].[QCL_SampleSetResurveyExclusion_StaticPlus]    Script Date: 8/18/2016 9:07:01 AM ******/
SET ANSI_NULLS ON
GO
