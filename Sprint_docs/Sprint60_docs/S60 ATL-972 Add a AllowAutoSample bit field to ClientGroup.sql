/*
	...
	ALTER TABLE [dbo].[ClientGroups] ADD AllowAutoSample
...
if not exists (	SELECT 1 
			...
			ALTER TABLE [dbo].[ClientGroups] 
				ADD [AllowAutoSample] bit NOT NULL CONSTRAINT [DF_ALLOWAUTOSAMPLE]  DEFAULT ((0))


GO

update [dbo].[ClientGroups] 
	SET AllowAutoSample = 1
WHERE ClientGroup_nm = 'OCS'
