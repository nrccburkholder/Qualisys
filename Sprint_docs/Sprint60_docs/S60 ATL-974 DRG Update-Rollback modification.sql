/*
	...
	S60 ATL-974 DRG Update/Rollback modification
	...
	ALTER PROCEDURE [dbo].[LD_SelectDRGUpdates]
	UPDATE [dbo].[CMSDataSubmissionSchedule] -- move date back one day
...
-- =============================================
ALTER PROCEDURE [dbo].[LD_SelectDRGUpdates] @Study_ID int
AS
BEGIN
...
SELECT df.[DataFile_id]
	...
	WHERE sub.SubmissionDateClose < CONVERT(date,GetDate())
...
/* change SubmissionDateClose back one day */
