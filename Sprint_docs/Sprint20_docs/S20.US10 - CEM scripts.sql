...
exec sp_rename 'cem.PullExportData', 'PullExportData_'
exec sp_rename 'cem.ExportPostProcess00000001', 'ExportPostProcess00000001_'
exec sp_rename 'cem.SelectExportQueue', 'SelectExportQueue_'
exec sp_rename 'cem.SelectTemplate', 'SelectTemplate_'
exec sp_rename 'cem.UpdateExportQueueFile', 'UpdateExportQueueFile_'
exec sp_rename 'cem.InsertExportQueueFile', 'InsertExportQueueFile_'
exec sp_rename 'cem.SelectExportQueueFile', 'SelectExportQueueFile_'
exec sp_rename 'cem.SelectExportData', 'SelectExportData_'
exec sp_rename 'cem.SelectExportTemplateColumn', 'SelectExportTemplateColumn_'
exec sp_rename 'cem.SelectExportTemplateColumnResponse', 'SelectExportTemplateColumnResponse_'
exec sp_rename 'cem.SelectTemplateSection', 'SelectTemplateSection_'
exec sp_rename 'cem.SelectSystemParams', 'SelectSystemParams_'