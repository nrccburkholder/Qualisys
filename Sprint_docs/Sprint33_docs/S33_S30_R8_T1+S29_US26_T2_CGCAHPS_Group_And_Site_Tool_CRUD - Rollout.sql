/*
-- =============================================
-- S33_S30_R8_T1+S29_US26_T2_CGCAHPS_Group_And_Site_Tool_CRUD - rollout.sql
-- Create date: July - September, 2015
...
DROP PROCEDURE QCL_SiteGroupSelect
DROP PROCEDURE QCL_SiteGroupsAndPracticeSitesSelect
DROP PROCEDURE QCL_PracticeSiteSelect
DROP PROCEDURE QCL_SiteGroupUpdate
DROP PROCEDURE QCL_SiteGroupInsert
DROP PROCEDURE QCL_PracticeSiteUpdate
DROP PROCEDURE QCL_PracticeSiteInsert
-- =============================================
*/
