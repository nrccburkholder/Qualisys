/*
	RTP-5056 MakeSurveysFromTemplate TagFields PackageTable Date fixes - Rollback.sql

	Chris Burkholder

	10/9/2017

	ALTER PROCEDURE [RTPhoenix].[MakeSurveysFromTemplate]
*/
USE [QP_Prod]
GO

/****** Object:  StoredProcedure [RTPhoenix].[MakeSurveysFromTemplate]    Script Date: 10/9/2017 12:37:11 PM ******/
SET ANSI_NULLS ON
GO
