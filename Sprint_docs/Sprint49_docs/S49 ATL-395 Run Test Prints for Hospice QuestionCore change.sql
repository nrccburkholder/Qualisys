...
ATL-401 Generate scripts for running mass generation of test prints for Rachel 

Used the following, with ‘1,2’ indicating to send the first two mail steps, if I understand it correctly - Chris Burkholder

*/

use QP_Prod

select 'exec sp_TESTPrints '+convert(varchar,cssv.survey_id) +', ''DC'', ''DC'',1,0,1,''1,2'',711,''rbeavers@nrcpicker.com''' 
from ClientStudySurvey_view cssv
inner join survey_def sd on sd.survey_id = cssv.survey_id 
where surveytype_id = 11 --Hospice
...
/* --below was run against production on 05/26/2016
...
exec sp_TESTPrints 19053, 'DC', 'DC',1,0,1,'1,2',711,'rbeavers@nrcpicker.com'
exec sp_TESTPrints 19076, 'DC', 'DC',1,0,1,'1,2',711,'rbeavers@nrcpicker.com'
exec sp_TESTPrints 19220, 'DC', 'DC',1,0,1,'1,2',711,'rbeavers@nrcpicker.com'
exec sp_TESTPrints 19241, 'DC', 'DC',1,0,1,'1,2',711,'rbeavers@nrcpicker.com'
exec sp_TESTPrints 19245, 'DC', 'DC',1,0,1,'1,2',711,'rbeavers@nrcpicker.com'
exec sp_TESTPrints 19571, 'DC', 'DC',1,0,1,'1,2',711,'rbeavers@nrcpicker.com'
exec sp_TESTPrints 19591, 'DC', 'DC',1,0,1,'1,2',711,'rbeavers@nrcpicker.com'
*/
