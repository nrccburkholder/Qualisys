...
begin        
 ...
 if exists (select 'x' from MetaData_view where Study_ID = @Study_ID and strField_nm = 'DRG')    
  ...
  insert into #log (RecordType, RecordsValue) values ('DRG Update Rollback Ignored', 'Your study does not contain a DRG field.')    
 ...
 if exists (select 'x' from MetaData_view where Study_ID = @Study_ID and strField_nm = 'MSDRG')    
  ...
  insert into #log (RecordType, RecordsValue) values ('MSDRG Update Rollback Ignored', 'Your study does not contain a MSDRG field.')    
...
if exists (select 'x' from MetaData_view where Study_ID = @Study_ID and strField_nm = 'APRDRG')    
  ...
  insert into #log (RecordType, RecordsValue) values ('APRDRG Update Rollback Ignored', 'Your study does not contain a APRDRG field.')    
