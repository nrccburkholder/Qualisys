/*
	S58 ATL-836 ATL-859 ACO & PQRS Standard Methodologies 2016 New Metafields
...
select @newACOPQRS = max(StandardMethodologyID) from StandardMethodology group by strStandardMethodology_nm having strStandardMethodology_nm = 'ACO-PQRS Mixed Mail-Phone'
...
update StandardMethodologyBySurveyType set bitExpired = 1 where StandardMethodologyID in (@ACO, @PQRS)
