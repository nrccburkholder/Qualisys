...
select top 1 * from SystematicSamplingTarget
...
--WHERE 1 = 2 --sampleset_id = @sampleset_id Moved to QCL_DeleteSampleSet; 
--TODO:Remove here and in StaticPlusAlgorithm.vb's PerformStaticPlusSample method CJB 9/15/2016
