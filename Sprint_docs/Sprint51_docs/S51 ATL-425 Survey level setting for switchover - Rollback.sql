...
IF EXISTS ( SELECT * FROM sys.columns   WHERE  object_id = OBJECT_ID(N'[dbo].[MAILINGSTEP]') AND name = 'ExcludePII' )
ALTER TABLE MAILINGSTEP
DROP COLUMN ExcludePII 
GO

IF EXISTS ( SELECT * FROM sys.columns   WHERE  object_id = OBJECT_ID(N'[dbo].[MethodologyStepType]') AND name = 'ExcludePII' )
ALTER TABLE METHODOLOGYSTEPTYPE
DROP COLUMN ExcludePII 
GO

IF EXISTS ( SELECT * FROM sys.columns   WHERE  object_id = OBJECT_ID(N'[dbo].[STANDARDMAILINGSTEP]') AND name = 'ExcludePII' )
ALTER TABLE STANDARDMAILINGSTEP
DROP COLUMN ExcludePII 
GO
