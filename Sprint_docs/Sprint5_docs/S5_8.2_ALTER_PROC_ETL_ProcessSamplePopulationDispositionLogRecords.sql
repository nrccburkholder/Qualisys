...
AS 
   ...
   --SET /*@DataFileID*/27 = 16
     ...
     -- select sp.datafileid,sp.id,v.cahpstypeid, v.study_id
	...
	begin
		declare @eligibilityOverride table (Q1 int, Q2 int, Q3to44Answers int,DispositionOverride int, CahpsDispositionOverride int)
		insert into @eligibilityOverride values (-9,-9,0,32,5130)-- [blank] (-9) / [blank] (-9)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,1,0,8,5160)	-- [blank] (-9) / < 3 months (1)								--> Ineligible: Does Not Meet Eligibility Criteria
																-- [blank] (-9) / 3 months+ (2-4*)								--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (-9,5,0,34,5190)-- [blank] (-9) / No longer at this facility (5)				--> Ineligible: No Longer Receiving Care at Sampled Facility
		insert into @eligibilityOverride values (1,-9,0,8,5160)	-- At home (1) / [blank] (-9)									--> Ineligible: Does Not Meet Eligibility Criteria
		insert into @eligibilityOverride values (1,1,0,32,5130)	-- At home (1) / < 3 months (1)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,2,0,32,5130)	-- At home (1) / 3-12 months (2)								--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,3,0,32,5130)	-- At home (1) / 1-5 years (3)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,4,0,32,5130)	-- At home (1) / 5 years + (4)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,5,0,32,5130)	-- At home (1) / No longer at this facility (5)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
																-- At the dialysis ctr (2) / [blank] (-9)						--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (2,1,0,8,5160)	-- At the dialysis ctr (2) / < 3 months (1)						--> Ineligible: Does Not Meet Eligibility Criteria
																-- At the dialysis ctr (2) / 3 months+ (2-4*)					--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (2,5,0,34,5190)	-- At the dialysis ctr (2) / No longer at this facility (5)		--> Ineligible: No Longer Receiving Care at Sampled Facility
		insert into @eligibilityOverride values (3,-9,0,33,5140)-- Do not currently rec'v (3) / [blank] (-9)					--> Ineligible: Not Receiving Dialysis
		insert into @eligibilityOverride values (3,1,0,32,5130)	-- Do not currently rec'v (3) / < 3 months (1)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,2,0,32,5130)	-- Do not currently rec'v (3) / 3-12 months (2)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,3,0,32,5130)	-- Do not currently rec'v (3) / 1-5 years (3)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,4,0,32,5130)	-- Do not currently rec'v (3) / 5 years+ (4)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,5,0,32,5130)	-- Do not currently rec'v (3) / No longer at this facility (5)	--> Completed Mail Questionnaire—Survey Eligibility Unknown
				
		insert into @eligibilityOverride values (-9,-9,1,32,5130)-- [blank] (-9) / [blank] (-9)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (-9,1,1,32,5130)-- [blank] (-9) / < 3 months (1)								--> Completed Mail Questionnaire—Survey Eligibility Unknown
																-- [blank] (-9) / 3 months+ (2-4*)								--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (-9,5,1,32,5130)-- [blank] (-9) / No longer at this facility (5)				--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,-9,1,32,5130)-- At home (1) / [blank] (-9)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,1,1,32,5130)	-- At home (1) / < 3 months (1)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,2,1,32,5130)	-- At home (1) / 3-12 months (2)								--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,3,1,32,5130)	-- At home (1) / 1-5 years (3)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,4,1,32,5130)	-- At home (1) / 5 years+ (4)									--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (1,5,1,32,5130)	-- At home (1) / No longer at this facility (5)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
																-- At the dialysis ctr (2) / [blank] (-9)						--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (2,1,1,32,5130)	-- At the dialysis ctr (2) / < 3 months (1)						--> Completed Mail Questionnaire—Survey Eligibility Unknown
																-- At the dialysis ctr (2) / 3 months+ (2-4*)					--> No override - use original heirarchical disposition
		insert into @eligibilityOverride values (2,5,1,32,5130)	-- At the dialysis ctr (2) / No longer at this facility (5)		--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,-9,1,32,5130)-- Do not currently rec'v (3) / [blank] (-9)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,1,1,32,5130)	-- Do not currently rec'v (3) / < 3 months (1)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,2,1,32,5130)	-- Do not currently rec'v (3) / 3-12 months (2)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
		insert into @eligibilityOverride values (3,3,1,32,5130)	-- Do not currently rec'v (3) / 1-5 years (3)					--> Completed Mail Questionnaire—Survey Eligibility Unknown
...
--		insert into @override
		...
		from (select qf.samplepopulationid
			...
			where rb.masterquestioncore in (51198,51199, -- Q1, Q2 (respectively)
		...
		inner join @eligibilityOverride eo on r.q1=eo.q1 and r.q2=eo.q2 and r.Q3to44Answers=eo.Q3to44Answers
	...
	CREATE INDEX IX_SamplePop ON #temp2 (SamplePopulationID)
	 ...
	 --For Cahps complete dispositions, verify that the sample pop's question form is complete  
	  ...
	  ,DispositionID = IsNull(lt.DispositionID_updated,lt.DispositionID)
	  			 --SELECT distinct IsNull(lt.CahpsDispositionID_updated,lt.CahpsDispositionID_initial)
	  FROM LOAD_TABLES.SamplePopulation lt WITH (NOLOCK)
