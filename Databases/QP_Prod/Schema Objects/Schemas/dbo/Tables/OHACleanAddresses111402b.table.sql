CREATE TABLE [dbo].[OHACleanAddresses111402b](
	[study_id] [int] NULL,
	[pop_id] [int] NULL,
	[addralt1] [varchar](60) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[strResult] [varchar](42) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
