CREATE TABLE [dbo].[DL_SEL_QSTNS_BySampleSet](
	...
	[DateCreated] [datetime] NULL CONSTRAINT [DF_DL_SEL_QSTNS_BySampleSet_DateCreated]  DEFAULT (getdate()),
 CONSTRAINT [PK_DLSELQSTNS] PRIMARY KEY CLUSTERED 
(
	[SampleSet_ID] ASC,
	[SELQSTNS_ID] ASC,
	[SURVEY_ID] ASC,
