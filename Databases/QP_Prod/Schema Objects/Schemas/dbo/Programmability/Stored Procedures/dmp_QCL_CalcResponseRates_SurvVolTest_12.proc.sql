...
*/  
CREATE PROCEDURE [dbo].[dmp_QCL_CalcResponseRates_SurvVolTest_12]
 @Survey_id INT
...
CREATE TABLE #SampleSets (SampleSet_id INT, datsamplecreate_dt datetime)
 ...
 SELECT SampleSet_id, datsamplecreate_dt
  ...
  WHERE datLastMailed IS NOT NULL
   ...
   --is datLastMailed within the past 12 months? 
   and datediff(month, dateadd(month, -12, getdate()),datlastmailed) >= 0
