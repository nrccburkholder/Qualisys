/****** Object:  Stored Procedure dbo.SP_liveDataClean    Script Date: 6/9/99 4:36:36 PM ******/
/****** Object:  Stored Procedure dbo.SP_liveDataClean     Script Date: 3/12/99 4:16:07 PM ******/
/*************************************************************
   This procedure cleans the live tables with rules applied
   for each metafield type. RC - 020599
   Revised by DPA on 03/01/99 - Previous version: OldSP_LiveDataClean
*************************************************************/
CREATE PROCEDURE SP_liveDataClean @study_id NUMERIC
AS
BEGIN
   SET NOCOUNT ON
...
*********************************************************************/
   ...
   BEGIN
      SELECT @workingString = 
                'DELETE S' + CONVERT(VARCHAR, @study_id) + '.' + @table_nm  +
