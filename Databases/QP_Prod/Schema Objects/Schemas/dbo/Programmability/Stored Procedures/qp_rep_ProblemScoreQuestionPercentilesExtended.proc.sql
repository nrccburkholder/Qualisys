CREATE  procedure qp_rep_ProblemScoreQuestionPercentilesExtended
@QstnCore int,
@BeginDate datetime,
@EndDate datetime,
@MinimumNSize int
...
insert into #rank (Client, Study, Survey, SampleUnit, Study_id, Survey_id, SampleUnit_id, Qstncore, ProblemScore, NSize)
  ...
  from NRCNormExtended_view n, sampleunit su, sampleplan sp, survey_def sd, study s, client c, nrc47.qp_comments.dbo.lu_problem_score ps
