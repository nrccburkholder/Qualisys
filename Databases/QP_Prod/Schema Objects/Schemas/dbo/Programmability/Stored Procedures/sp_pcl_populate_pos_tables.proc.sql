...
**
** 3/16/09.  - v2.0.2 - Michael Beltz	 Added as debuging to see why some questionforms are not being populated.  

*/  
CREATE procedure sp_pcl_populate_pos_tables  
 @batch_id int  
as  
 declare @name varchar(255), @batch_size int, @err int  
 select @batch_size = numParam_value  
 from QP_Prod.dbo.qualpro_params  
