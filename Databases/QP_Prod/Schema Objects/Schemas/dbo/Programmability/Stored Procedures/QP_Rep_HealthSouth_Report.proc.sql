CREATE procedure QP_Rep_HealthSouth_Report
...
[Response Rate] numeric(5,2), RcvdRecordsWeek int, GoodRecordsWeek int, [Should Send] int, [Will Send] int, Variance int)
