/*********************************************************************************************
	qp_Rep_ActionPlanProperties

	This SP will return property information for any action plan that contains one or more
...
CREATE  PROCEDURE [dbo].[qp_Rep_ActionPlanProperties]
 ...
 EXECUTE datamart.qp_comments.dbo.qp_Rep_ActionPlanProperties @associate, @client, @study, @survey, @survey_id
