CREATE proc SSRS_MissingIncompleteLithos_NoFinal (@Sampleset_ID int)    
as    
...
--shows where no isFinal dispositions exist    
...
where ss.sampleset_ID= sp.sampleset_ID and    
            ...
            qf.sentmail_ID = sm.sentmail_ID and           
            ss.sampleset_ID = @Sampleset_ID and    
            sm.strlithocode not in (select strlithocode from #AllIsFinalDispositionsRecords) and    
            sm.strlithocode  in (select strlithocode from #AllNonIsFinalDispositionsRecords)    
