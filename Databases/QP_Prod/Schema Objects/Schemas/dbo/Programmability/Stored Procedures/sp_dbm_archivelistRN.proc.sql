CREATE procedure sp_dbm_archivelistRN  
@intmonths int  
as  
...
set @tolist = @tolist + 'dba@nationalresearch.com'  
...
set @strsql = 'master.dbo.xp_sendmail @recipients = "dba@nationalresearch.com", ' + char(10) +   
