--MailingStep_id	intSequence	strMailingStep_nm	datgened	datprinted	datMailed	ScheduledGenerateDate	GenCount
--22523	1	Phone	2011-04-13	2011-04-13	2011-04-13	2011-04-13	240
 
CREATE PROCEDURE sp_DBA_RollbackGeneration_BySampleSetID @sampleset_id INT,@Survey_id INT,@CurrentMailingStep INT=NULL, @intSequence INT=NULL,  @datGenerated DATETIME=NULL  ,  @datMailed DATETIME=NULL, @ScheduledToGenerate DATETIME=NULL
AS      
...
where sp.sampleset_id = @sampleset_id  
...
if @datMailed is null       
 begin          
  ...
  AND sp.sampleset_id = @sampleset_id
...
PRINT 'DELETE next ScheduledMailing with -1 Sentmail_IDs'           
 DELETE ScheduledMailing            
  ...
  sp.sampleset_id = @sampleset_id AND    
