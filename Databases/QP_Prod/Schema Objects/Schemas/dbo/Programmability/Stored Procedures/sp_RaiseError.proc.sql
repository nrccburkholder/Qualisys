...
** 9/12/2008 DRM - Added check for application named 'NRCPCLGEN%' from pclgen.  These were erroring out.  
** 10/15/2009 MWB - Changed all xp_sendmail to sp_send_dbmail for SQL 2008 upgrade.
** 10/9/2013 DRH - Changed to add country, environment and server alias for Canada Qualisys Upgrade
*/    
...
--DRM 9/12/2008  
if @strApplication_nm like 'NRCPCLGEN%'   
 set @strApplication_nm = 'PCLGen'  
...
/* Now, do the following actions based on the Severity passed in */    
  ...
  begin    
	...
	exec qp_prod.dbo.sp_getemailsubject @subject,@country, @environment, 'Qualisys', @osubject=@subject output
