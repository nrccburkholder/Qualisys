create procedure APlan_CalcChi90
as
create table #chitemp (sampunit int, qstncore int, response int, b1 int, b2 int, n1 int, n2 int, 
...
update #chitemp set sig = '<' 
where (chin>=2.706 and n1>0 and b1*100/n1<chip) 
