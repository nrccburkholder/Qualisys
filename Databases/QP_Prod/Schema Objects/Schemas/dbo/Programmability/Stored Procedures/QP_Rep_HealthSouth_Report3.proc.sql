/* Need to incorporate status, visittype, and facility name into the report */
CREATE procedure QP_Rep_HealthSouth_Report3
...
Create table #report (sampleunit_id int, [Facility Number] varchar(42), [Facility Name] varchar(42), Status varchar(10), [Qtr Goal] int, 
SentSurveysQTD int, RtrndSurveysQTD int, [Response Rate] numeric(5,2), RcvdRecordsWeek int, GoodRecordsWeek int, [Should Send] int, [Will Send] int, Variance int)
