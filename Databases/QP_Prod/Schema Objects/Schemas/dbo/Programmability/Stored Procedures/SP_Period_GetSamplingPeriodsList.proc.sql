/***********************************************************************************************
*	Procedure Name:
		dbo.SP_Period_GetSamplingPeriodsList
*
*	Description:
		This will return a list of periods that can be sampled for a given survey.
*
*	Parameters:
		@survey_id
...
*
*	History:
		release 1.0  Feb 10, 2004 by Dan Christensen
			Initial Release
************************************************************************************************/

CREATE     PROCEDURE dbo.SP_Period_GetSamplingPeriodsList
	@survey_id int
AS
...
--Delete any periods that are in the future

DELETE
FROM #PERIODS
WHERE perioddef_id in 
	(select p.perioddef_id
	 from #periods p, perioddates pd
	 WHERE p.perioddef_id=pd.perioddef_id and
