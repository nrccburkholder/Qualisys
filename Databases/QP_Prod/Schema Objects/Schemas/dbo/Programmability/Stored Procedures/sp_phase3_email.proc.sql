CREATE procedure sp_phase3_email
as
...
WHERE CommentType in ('Service Alert','Contact')
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @Subject = 'Service Alert Survey ' + convert(varchar,@surveyid)
...
*/       
        ...
        SET @strSql = 'master..xp_sendmail @recipients = ''' + @Recip + ''', ' + char(10) +
                      ...
                      '                    @blind_copy_recipients = ''JFleming@NationalResearch.com;PErnesti'', ' + char(10) +
