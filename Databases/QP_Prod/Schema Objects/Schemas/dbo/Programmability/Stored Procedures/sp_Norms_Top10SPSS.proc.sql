create procedure sp_Norms_Top10SPSS 
@NRCTop10 varchar(40), 
@SPSSTable varchar(40)
as

declare @SQL varchar(2000), @begindate datetime, @enddate datetime
...
set @SQL = 'insert into ' + @SPSSTable + ' (qstncore, nu, nw, sm, ss)' +char(10)+
'select qstncore,sum(UWNSize),sum(UWNSize),sum(UWNsize*intResponseVal),sum(UWNsize*intResponseVal*intresponseval)'+char(10)+
'from ' + @NRCTop10 +char(10)+
'where qstncore <> 7666' +char(10)+
'group by qstncore'
exec(@SQL)

--select * from JC_2002Q1_Top10
