...
/* DG 1/22/2004 - added code to account for test prints */
CREATE PROCEDURE sp_pcl_load_sel_pcl
 @batch_id int
AS
 ...
 DECLARE @testPrints bit
 SELECT @testprints=bitTestPrints from #myPCLNeeded
 if @testprints=0
	SELECT
	...
	FROM
	  dbo.PCL_PCL sp, #pclloadselpcl tp
