...
CREATE  PROCEDURE [dbo].[qp_Rep_ActionPlanUnits]
 ...
 EXECUTE datamart.qp_comments.dbo.qp_Rep_ActionPlanUnits @associate, @client, @study, @survey, @survey_id
