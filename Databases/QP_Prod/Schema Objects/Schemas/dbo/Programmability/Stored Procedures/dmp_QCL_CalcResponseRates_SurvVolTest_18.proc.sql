...
*/  
CREATE PROCEDURE [dbo].[dmp_QCL_CalcResponseRates_SurvVolTest_18]
 @Survey_id INT
...
CREATE TABLE #SampleSets (SampleSet_id INT, datsamplecreate_dt datetime)
 ...
 SELECT SampleSet_id, datsamplecreate_dt
  ...
  WHERE datLastMailed IS NOT NULL
   ...
   --is datLastMailed within the past 18 months? 
   and datediff(month, dateadd(month, -18, getdate()),datlastmailed) >= 0
