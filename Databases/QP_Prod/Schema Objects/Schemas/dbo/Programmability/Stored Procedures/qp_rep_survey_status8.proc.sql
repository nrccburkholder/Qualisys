CREATE procedure qp_rep_survey_status8
...
select language 'Survey language(s)' from languages l, surveylanguage sl where l.langid = sl.langid and sl.survey_id = @intsurvey_id
