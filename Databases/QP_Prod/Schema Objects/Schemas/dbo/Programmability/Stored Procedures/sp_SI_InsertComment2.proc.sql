CREATE PROCEDURE sp_SI_InsertComment2 
    @CmntType       int,
    @CmntValence    int,
    @SampleUnitID   int,
    @QstnCore       int,
...
VALUES (@CmntType, @CmntValence, @SampleUnitID, @QstnCore, 
        ...
        @CmntOrHand, @CmntText1, @CmntTextUM1, GetDate())

--Save the CmntID
SELECT @CmntID = Cmnt_id FROM Comments WHERE QuestionForm_id = @QuestionFormID and QstnCore = @QstnCore and strCmntOrHand = @CmntOrHand
