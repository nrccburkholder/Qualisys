CREATE PROCEDURE SP_NORMS_SampleUnitDef @Survey INT
AS
...
FROM Medusa.qp_comments.dbo.sampleunit
WHERE Survey_id=@Survey

DELETE t
FROM #SampleUnits t LEFT OUTER JOIN SampleUnit su
ON t.SampleUnit_id=su.SampleUnit_id
WHERE su.SampleUnit_id IS NULL
