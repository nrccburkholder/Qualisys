/****** Object:  Stored Procedure dbo.sp_Samp_HouseHoldingMinor    Script Date: 9/28/99 2:57:15 PM ******/
/***********************************************************************************************************************************
SP Name: sp_Samp_HouseHoldingMinor
Part of:  Sampling Tool
Purpose:  Householding algorithm for householding option: Minor Only
  1. Compare Householding between Minors in the Sample Unit Universe with 
   Minors in other Sample Sets.
  2. Compare Minors within the Sample Unit Universe
Input:  
  ...
  @strMinorException_Where   Minor exclusion criteria (used in where clause) 
...
Revision: DC - 03-10-2004 Added code to join to random number table
***********************************************************************************************************************************/
CREATE       PROCEDURE sp_Samp_HouseHoldingMinor
...
AS
 ...
 SET @HHRemoveRule = 6
	...
	--values ('sp_Samp_HouseHoldingMinor', getdate())
/***********************************************************
 ...
 */
 ...
 /* (a1f) From each sample set on the study, insert into #Minor_Exclude everyone 
  ...
  and has the same Householding Fields as a minor in #Minor_Universe. */ SELECT @strSQL = 
