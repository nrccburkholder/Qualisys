CREATE procedure qp_rep_survey_status9
...
select count(*) as 'Number of comment boxes' from sel_qstns where subtype = 4 and height > 0 and survey_id = @intsurvey_id and language = 1
