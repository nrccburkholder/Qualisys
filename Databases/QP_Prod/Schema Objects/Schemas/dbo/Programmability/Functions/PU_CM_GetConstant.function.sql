...
CREATE FUNCTION dbo.PU_CM_GetConstant(
         @strConstantName     varchar(64)
       ) RETURNS int
AS
BEGIN
  ...
  RETURN(CASE @strConstantName
           ...
           WHEN 'ADDR_TO'                   THEN 1
           WHEN 'ADDR_FROM'                 THEN 2
           WHEN 'ADDR_CC'                   THEN 3
           WHEN 'ADDR_WEBACCOUNT'           THEN 4

           WHEN 'TITLE_CLIENT_NAME'         THEN 1
           WHEN 'TITLE_PU_NAME'             THEN 2

           WHEN 'SAMPLING_METHOD_TARGETS'   THEN 1
           WHEN 'SAMPLING_METHOD_OUTGO'     THEN 2
           WHEN 'SAMPLING_METHOD_CENSUS'    THEN 3
