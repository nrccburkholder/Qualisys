...
Public Class WestVRTDispositionSection
#Region " Fields "
    Dim mNavigator As WestVRTDispositionNavigator
#End Region
#Region " Overrides "
    Public Overrides Sub RegisterNavControl(ByVal navCtrl As Navigator)
        MyBase.RegisterNavControl(navCtrl)

        mNavigator = TryCast(navCtrl, WestVRTDispositionNavigator)
...
#Region " Private Methods "
    ...
    Private Sub ImportFile()
        ...
        Dim myDispositions As New VRTDispositionWests
        Dim errorCaught As Boolean = False
        Try
            Dim TempDir As String = "C:\TempWestVRTDispSchema"
            ...
            For Each row As Data.DataRow In CleanedData.Rows
                ...
                myDispositions.Add(VRTDispositionWest.NewVRTDispositionWest(respID, callOutcome, dateTimeStamp, CallType))
            Next
        ...
        If Not errorCaught Then
            If myDispositions.GenericCount > 0 Then 'There are rows to process
                Dim sb As StringBuilder = myDispositions.ProcessVRTDispositionWestImport()
    ...
    Public Sub CreateSchemaINIFile(ByVal fileName As String)
        ...
        Try
            ' DateTimeStamp,VendorCallidKey,VendorCompanyId,PhoneNumber,CallOutcome,CallType,RespondentID,VendorActvityId
            schemaWriter = File.CreateText("C:\TempWestVRTDispSchema\Schema.ini")
            ...
            schemaWriter.WriteLine("Col2=VendorCallidKey Text")
            schemaWriter.WriteLine("Col3=VendorCompanyId Text")
            schemaWriter.WriteLine("Col4=PhoneNumber Text")
            ...
            schemaWriter.WriteLine("Col8=VendorActvityId Text")
