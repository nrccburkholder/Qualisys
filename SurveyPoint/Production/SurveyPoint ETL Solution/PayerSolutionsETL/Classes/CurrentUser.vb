...
Public NotInheritable Class CurrentUser
    ...
    Public Shared ReadOnly Property HasApplicationAccess() As Boolean
        Get                        
            If Member Is Nothing Then
                Return False
            Else
                Return Member.HasMemberPrivilege(AppName, "Access Survey Point ETL")
            End If
        End Get
    End Property
    ...
    ''' <DateModified>11/8/2007</DateModified>
    ''' <ModifiedBy>Tony Piccoli</ModifiedBy>
    Public Shared ReadOnly Property HasCoventrySplitAccess() As Boolean
        Get
            If Member Is Nothing Then
                Return False
            Else
                Return Member.HasMemberPrivilege(AppName, "Coventry Split")
            End If
        End Get
    End Property
    Public Shared ReadOnly Property HasImportUpdateAccess() As Boolean
        Get
            If Member Is Nothing Then
                Return False
            Else
                Return Member.HasMemberPrivilege(AppName, "Import Update")
            End If
        End Get
    End Property
    ''' <summary>This is an example of an NRC Auth permission you can set.</summary>
    ...
    ''' <DateModified>11/8/2007</DateModified>
    ''' <ModifiedBy>Tony Piccoli</ModifiedBy>
    Public Shared ReadOnly Property HasWellpointSplitAccess() As Boolean
        Get
            If Member Is Nothing Then
                Return False
            Else
                Return Member.HasMemberPrivilege(AppName, "Wellpoint Split")
            End If
        End Get
    End Property
    Public Shared ReadOnly Property HasWebCSVAccess() As Boolean
        Get
            If Member Is Nothing Then
                Return False
            Else
                Return Member.HasMemberPrivilege(AppName, "Web CSV Split")
            End If
        End Get
    End Property
    Public Shared ReadOnly Property HasLifestylesExportAccess() As Boolean
        Get
            If Member Is Nothing Then
                Return False
            Else
                Return Member.HasMemberPrivilege(AppName, "LifeStyles Export")
            End If
        End Get
    End Property
