...
Public Interface IExportMedicare2012QFileID
    Property ExportMedicare2012QFileID() As Integer
End Interface

''' <summary>This object represents a record for the answer file.</summary>
''' <CreatedBy>Tony Piccoli</CreatedBy>
''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
Public Class ExportMedicare2012QFile
    Inherits BusinessBase(Of ExportMedicare2012QFile)
    Implements IExportMedicare2012QFileID

#Region " Private Fields "
    <NotUndoable()> Private mInstanceGuid As Guid = Guid.NewGuid

    'Respondent Answer Fields
    Private mExportMedicare2012QFileID As Integer
    ...
    Private mParent As ExportMedicare2012QFileController
#End Region
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportMedicare2012QFileID() As Integer Implements IExportMedicare2012QFileID.ExportMedicare2012QFileID
        Get
            Return Me.mExportMedicare2012QFileID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportMedicare2012QFileID Then
                mExportMedicare2012QFileID = value
                PropertyHasChanged("ExportMedicare2012QFileID")
            End If
        End Set
    End Property
...
#End Region
    ...
    Public Property TotalRecordCount() As Integer
        ...
        End Set
    End Property
    Public Property ParentQuestionFileController() As ExportMedicare2012QFileController
        Get
            Return Me.mParent
        End Get
        Set(ByVal value As ExportMedicare2012QFileController)
            Me.mParent = value
    ...
    Public ReadOnly Property Answer_Code() As String
        Get
            ...
            Select Case Me.mAnswerCategoryTypeID
                ...
                Case Else
                    Return charString(Me.mAnswerValue.ToString(), 10)
            End Select
        End Get
    End Property
...
#Region " Factory Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicare2012QFile() As ExportMedicare2012QFile
        'TODO:  Overload constructor.
        Return New ExportMedicare2012QFile()
    End Function
    Public Shared Function CreateQuestionFileCollection(ByVal questionController As ExportMedicare2012QFileController, ByVal exportGroupID As Integer) As ExportMedicare2012QFileCollection
        Return ExportMedicare2012QFileProvider.Instance.CreateQuestionFileCollection(questionController, exportGroupID)
    End Function
#End Region
...
#Region " Basic Overrides "
    ...
    Protected Overrides Function GetIdValue() As Object
        ...
        Else
            Return mExportMedicare2012QFileID
        End If
    End Function
