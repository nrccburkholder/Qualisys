...
Public Interface IExportMedicareRFileID
    Property ExportMedicareRFileID() As Integer
End Interface

''' <summary>This object represents a record for the answer file.</summary>
''' <CreatedBy>Tony Piccoli</CreatedBy>
''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
Public Class ExportMedicareRFile
    Inherits BusinessBase(Of ExportMedicareRFile)
    Implements IExportMedicareRFileID

#Region " Private Fields "
    <NotUndoable()> Private mInstanceGuid As Guid = Guid.NewGuid

    'Respondent Answer Fields
    Private mExportMedicareRFileID As Integer
    ...
    Private mParent As ExportMedicareRFileController
#End Region
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportMedicareRFileID() As Integer Implements IExportMedicareRFileID.ExportMedicareRFileID
        Get
            Return Me.mExportMedicareRFileID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportMedicareRFileID Then
                mExportMedicareRFileID = value
                PropertyHasChanged("ExportMedicareRFileID")
            End If
        End Set
    End Property
...
#Region " FieldPropeties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public ReadOnly Property ParentController() As ExportMedicareRFileController
        Get
            Return Me.mParent
        End Get
    End Property
...
#Region " Constructors "
    Protected Sub New(ByVal parent As ExportMedicareRFileController, ByVal totalRecordCount As Integer)
        Me.CreateNew()
        Me.mParent = parent
...
#Region " Factory Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicareRFile(ByVal parent As ExportMedicareRFileController, ByVal totalRecordCount As Integer) As ExportMedicareRFile
        'TODO:  Overload constructor.
        Return New ExportMedicareRFile(parent, totalRecordCount)
    End Function
