...
Public Interface IExportMedicareRFileControllerID
    Property ExportMedicareRFileControllerID() As Integer
End Interface
...
Public Class ExportMedicareRFileController
    Inherits BusinessBase(Of ExportMedicareRFileController)
    Implements IExportMedicareRFileControllerID

#Region " Private Fields "
    <NotUndoable()> Private mInstanceGuid As Guid = Guid.NewGuid

    Private mExportMedicareRFileCollection As ExportMedicareRFileCollection
    Private mResultFileExported As Boolean = False
    Private mMarkSubmitted As Boolean
    Private mExportMedicareRFileControllerID As Integer
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportMedicareRFileControllerID() As Integer Implements IExportMedicareRFileControllerID.ExportMedicareRFileControllerID
        Get
            Return Me.mExportMedicareRFileControllerID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportMedicareRFileControllerID Then
                mExportMedicareRFileControllerID = value
                PropertyHasChanged("ExportMedicareRFileControllerID")
            End If
        End Set
    End Property
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public ReadOnly Property ResultFileCollection() As ExportMedicareRFileCollection
        Get
            Return Me.mExportMedicareRFileCollection
        End Get
    End Property
...
#Region " Constructors "
    ...
    Protected Sub New(ByVal parent As ExportMedicareFile, ByVal ExportLogFileID As Integer, ByVal origLogFileID As Integer, ByVal exportGroupID As Integer, _
...
#Region " Factory Methods "
    ...
    ''' <returns>ExportMedicareRFileController</returns>
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicareRFileController(ByVal parent As ExportMedicareFile, ByVal exportFileID As Integer, _
    ...
    ByVal startDate2401 As Nullable(Of Date), ByVal endDate2401 As Nullable(Of Date), ByVal resultFilePath As String, ByVal activeOnly As Boolean) As ExportMedicareRFileController
        Dim totalRespondents As Long = ExportMedicareRFileController.GetNumberOfRespondentsByExportGroup(exportGroupID, exportFileID, origLogFileID, markSubmitted, rerunUserLogdates, startDate2401, endDate2401, activeOnly)
        ...
        End If
        Dim resultController As ExportMedicareRFileController = New ExportMedicareRFileController(parent, exportFileID, origLogFileID, exportGroupID, markSubmitted, rerunUserLogdates, startDate2401, endDate2401, resultFilePath, activeOnly)
    ...
    Public Shared Function GetNumberOfRespondentsByExportGroup(ByVal exportGroupID As Integer, ByVal logFileID As Integer, ByVal origLogFileID As Integer, ByVal markSubmitted As Boolean, ByVal rerunUsingLogDates As Boolean, ByVal startDate2401 As Nullable(Of Date), ByVal endDate As Nullable(Of Date), ByVal activeOnly As Boolean) As Long
        Return ExportMedicareRFileControllerProvider.Instance.GetNumberOfRespondentsForExportGroup(exportGroupID, logFileID, origLogFileID, markSubmitted, rerunUsingLogDates, startDate2401, endDate, activeOnly)
    End Function
#End Region
...
#Region " Public Methods "
    ...
    Public Function PrintFile() As Integer
        ...
        Try
            ...
            Dim fileRecord As ExportMedicareRFile
            ...
            For Each row As Data.DataRow In Me.mResultConntroller.Tables("RespondentAnswers").Rows
                ...
                fileRecord = ExportMedicareRFile.NewExportMedicareRFile(Me, totalRecordCount)
                With fileRecord
                    .BeginPopulate()
            ...
            Next
            'End TP 20080604
            'For Each row As ExportMedicareRFile In Me.mExportMedicareRFileCollection
...
#Region " Private and Protected Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Private Sub ValidateUserInputFields(ByVal resultRecord As ExportMedicareRFile)
    ...
    Private Sub LoadResultResponseCollection()
        ...
        'Me.mExportMedicareRFileCollection = New ExportMedicareRFileCollection
        ''TODO:  Switch bake to datatable once sort is in the DB.
        'For Each row As DataRow In Me.mResultTable.Rows
        '    Dim exportResultFile As ExportMedicareRFile = ExportMedicareRFile.NewExportMedicareRFile(Me, totalRecordCount)
        ...
        '        .EndPopulate()
        '    End With
        '    Me.mExportMedicareRFileCollection.Add(exportResultFile)
        'Next
    End Sub
    ...
    Protected Sub LoadControllerDataSet()
        ...
        Me.mResultConntroller = ExportMedicareRFileControllerProvider.Instance.GetResultFileDataSet(Me.mExportGroupID, Me.mLogFileID, Me.mOrigLogFileID, Me.MarkSubmitted, Me.mRerunUsingLogDates, Me.m2401StartDate, Me.m2401EndDate, Me.mActiveOnly)
    End Sub
