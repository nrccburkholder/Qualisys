...
Public Interface IExportMedicareFileID
    Property ExportMedicareFileID() As Integer
End Interface
...
Public Class ExportMedicareFile
    Inherits BusinessBase(Of ExportMedicareFile)
    Implements IExportMedicareFileID
...
#Region " Private Fields "
    ...
    Private mQuestionFileController As ExportMedicareQFileController
    Private mResultFileController As ExportMedicareRFileController
    Private mExportMedicareFileID As Integer
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportMedicareFileID() As Integer Implements IExportMedicareFileID.ExportMedicareFileID
        Get
            Return Me.mExportMedicareFileID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportMedicareFileID Then
                mExportMedicareFileID = value
                PropertyHasChanged("ExportMedicareFileID")
            End If
        End Set
    End Property
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Protected Property QuestionFileController() As ExportMedicareQFileController
        Get
            If Me.mQuestionFileController Is Nothing Then
                Me.mQuestionFileController = ExportMedicareQFileController.NewExportMedicareQFileController(Me, Me.mExportLogFile.ExportGroupID, Me.mExportLogFile.QuestionFileName)
            End If
            Return Me.mQuestionFileController
        End Get
        'Set should only be used for memory release.
        Private Set(ByVal value As ExportMedicareQFileController)
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Protected Property ResultFileController() As ExportMedicareRFileController
        Get
            If Me.mResultFileController Is Nothing Then
                Me.mResultFileController = ExportMedicareRFileController.NewExportMedicareRFileController(Me, Me.mExportLogFile.ExportLogFileID, Me.mOriginalLogFileID, Me.mExportLogFile.ExportGroupID, Me.mExportLogFile.MarkSubmitted, Me.mRerunUsingLogDates, Me.mExportGroup.RerunCodeStartDate, Me.mExportGroup.RerunCodeEndDate, Me.mExportLogFile.AnswerFileName, Me.mActiveOnly)
            End If
            Return Me.mResultFileController
        End Get
        'Set should only be used for memory release.
        Private Set(ByVal value As ExportMedicareRFileController)
...
#Region " Factory Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicareFile() As ExportMedicareFile
        Return New ExportMedicareFile
    End Function
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicareFile(ByVal eg As ExportGroup, ByVal userID As Integer, ByVal userName As String, ByVal markSubmitted As Boolean, ByVal pActiveOnly As Boolean) As ExportMedicareFile
        Dim newObject As ExportMedicareFile = New ExportMedicareFile(eg, userID, userName, markSubmitted, pActiveOnly)
        Return newObject
    End Function
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicareFileFromRerun(ByVal logFileID As Integer, ByVal userID As Integer, ByVal userName As String, ByVal markSubmitted As Boolean, ByVal start2401Date As Nullable(Of Date), ByVal end2401Date As Nullable(Of Date), ByVal pActiveOnly As Boolean) As ExportMedicareFile
        Dim newObject As ExportMedicareFile = New ExportMedicareFile(logFileID, userID, userName, markSubmitted, start2401Date, end2401Date, pActiveOnly)
        Return newObject
    End Function
#End Region
...
#Region " Data Access "
    ...
    Public Sub Mark2401EventForLogFile()
        If Me.mExportLogFile.MarkSubmitted Then
            ExportMedicareFileProvider.Instance.Mark2401ForLog(Me.mExportLogFile.ExportLogFileID)
        End If
    End Sub
#End Region
