...
Public Interface IExportWPMedicareQFileID
    Property ExportWPMedicareQFileID() As Integer
End Interface

''' <summary>This object represents a record for the answer file.</summary>
''' <CreatedBy>Tony Piccoli</CreatedBy>
''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
Public Class ExportWPMedicareQFile
    Inherits BusinessBase(Of ExportWPMedicareQFile)
    Implements IExportWPMedicareQFileID

#Region " Private Fields "
    <NotUndoable()> Private mInstanceGuid As Guid = Guid.NewGuid

    'Respondent Answer Fields
    Private mExportWPMedicareQFileID As Integer
    ...
    Private mParent As ExportWPMedicareQFileController
#End Region
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportWPMedicareQFileID() As Integer Implements IExportWPMedicareQFileID.ExportWPMedicareQFileID
        Get
            Return Me.mExportWPMedicareQFileID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportWPMedicareQFileID Then
                mExportWPMedicareQFileID = value
                PropertyHasChanged("ExportWPMedicareQFileID")
            End If
        End Set
    End Property
...
#End Region
    ...
    Public Property TotalRecordCount() As Integer
        ...
        End Set
    End Property
    Public Property ParentQuestionFileController() As ExportWPMedicareQFileController
        Get
            Return Me.mParent
        End Get
        Set(ByVal value As ExportWPMedicareQFileController)
            Me.mParent = value
...
#Region " Read Only Display Properties "
    ...
    Public ReadOnly Property Answer_Desc() As String
        Get
            Return Replace(Me.mAnswerText, vbCrLf, "")
        End Get
    End Property
...
#Region " Factory Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportWPMedicareQFile() As ExportWPMedicareQFile
        'TODO:  Overload constructor.
        Return New ExportWPMedicareQFile()
    End Function
    Public Shared Function CreateQuestionFileCollection(ByVal questionController As ExportWPMedicareQFileController, ByVal exportGroupID As Integer) As ExportWPMedicareQFileCollection
        Return ExportWPMedicareQFileProvider.Instance.CreateQuestionFileCollection(questionController, exportGroupID)
    End Function
#End Region
...
#Region " Basic Overrides "
    ...
    Protected Overrides Function GetIdValue() As Object
        ...
        Else
            Return mExportWPMedicareQFileID
        End If
    End Function
...
#Region " Public Methods "
    Public Function PrintHeadlerLine() As String
        Return "vendor_code|hra_version|question_ID|batch_date|req_field_flag|hra_version_date|question_order|question_desc|answer_type|answer_cd|answer_desc|lob_cd"
    End Function
    Public Function PrintTrailerFileHeader() As String
