...
Public Interface IExportWPMedicareRFileControllerID
    Property ExportWPMedicareRFileControllerID() As Integer
End Interface
...
Public Class ExportWPMedicareRFileController
    Inherits BusinessBase(Of ExportWPMedicareRFileController)
    Implements IExportWPMedicareRFileControllerID

#Region " Private Fields "
    <NotUndoable()> Private mInstanceGuid As Guid = Guid.NewGuid

    Private mExportWPMedicareRFileCollection As ExportWPMedicareRFileCollection
    Private mResultFileExported As Boolean = False
    Private mMarkSubmitted As Boolean
    Private mExportWPMedicareRFileControllerID As Integer
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportWPMedicareRFileControllerID() As Integer Implements IExportWPMedicareRFileControllerID.ExportWPMedicareRFileControllerID
        Get
            Return Me.mExportWPMedicareRFileControllerID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportWPMedicareRFileControllerID Then
                mExportWPMedicareRFileControllerID = value
                PropertyHasChanged("ExportWPMedicareRFileControllerID")
            End If
        End Set
    End Property
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public ReadOnly Property ResultFileCollection() As ExportWPMedicareRFileCollection
        Get
            Return Me.mExportWPMedicareRFileCollection
        End Get
    End Property
...
#Region " Constructors "
    ...
    Protected Sub New(ByVal parent As ExportWPMedicareFile, ByVal ExportLogFileID As Integer, ByVal origLogFileID As Integer, ByVal exportGroupID As Integer, _
...
#Region " Factory Methods "
    ...
    ''' <returns>ExportWPMedicareRFileController</returns>
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportWPMedicareRFileController(ByVal parent As ExportWPMedicareFile, ByVal exportFileID As Integer, _
    ...
    ByVal startDate2401 As Nullable(Of Date), ByVal endDate2401 As Nullable(Of Date), ByVal resultFilePath As String, ByVal ActiveOnly As Boolean) As ExportWPMedicareRFileController
        Dim totalRespondents As Long = ExportWPMedicareRFileController.GetNumberOfRespondentsByExportGroup(exportGroupID, exportFileID, origLogFileID, markSubmitted, rerunUserLogdates, startDate2401, endDate2401, ActiveOnly)
        ...
        End If
        Dim resultController As ExportWPMedicareRFileController = New ExportWPMedicareRFileController(parent, exportFileID, origLogFileID, exportGroupID, markSubmitted, rerunUserLogdates, startDate2401, endDate2401, resultFilePath, ActiveOnly)
    ...
    Public Shared Function GetNumberOfRespondentsByExportGroup(ByVal exportGroupID As Integer, ByVal logFileID As Integer, ByVal origLogFileID As Integer, ByVal markSubmitted As Boolean, ByVal rerunUsingLogDates As Boolean, ByVal startDate2401 As Nullable(Of Date), ByVal endDate As Nullable(Of Date), ByVal ActiveOnly As Boolean) As Long
        Return ExportWPMedicareRFileControllerProvider.Instance.GetNumberOfRespondentsForExportGroup(exportGroupID, logFileID, origLogFileID, markSubmitted, rerunUsingLogDates, startDate2401, endDate, ActiveOnly)
    End Function
#End Region
...
#Region " Public Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term>Tony Piccoli  20080818</term><description>Printing a separate trailer file for Wellpoint</description></item><item><term></term><description></description></item></list></RevisionList>
    Public Function PrintFile() As Integer
        ...
        Try
            ...
            Dim fileRecord As ExportWPMedicareRFile
            ...
            For Each row As Data.DataRow In Me.mResultConntroller.Tables("RespondentAnswers").Rows
                ...
                If currentRespondentID = 0 OrElse respondentID <> currentRespondentID Then
                    ...
                    middleInitial = NullString(respondentDataRow("MiddleInitial"))
                    address1 = NullString(respondentDataRow("Address1"))
                    address2 = NullString(respondentDataRow("Address2"))
                    city = NullString(respondentDataRow("City"))
                    state = NullString(respondentDataRow("State"))
                    zip = NullString(respondentDataRow("PostalCode"))
                    telephone = NullString(respondentDataRow("TelephoneDay"))
                    gender = NullString(respondentDataRow("Gender"))
                    Dim tempClientRespID As String = Replace(NullString(respondentDataRow("ClientRespondentID")), "-", "")
                    If tempClientRespID Is Nothing Then
                        tempClientRespID = ""
                    End If
                    If Not tempClientRespID Is Nothing AndAlso tempClientRespID.Length > 9 Then
                        tempClientRespID = tempClientRespID.Substring(0, 9)
                    End If
                    clientRespID = tempClientRespID
                ...
                fileRecord = ExportWPMedicareRFile.NewExportWPMedicareRFile(Me, totalRecordCount)
                With fileRecord
                    .BeginPopulate()
                    ...
                    .LastName = lastName
                    .DOB = dob
                    .Member_MI = NullString(middleInitial)
                    .Address1 = NullString(address1)
                    .Address2 = NullString(address2)
                    .City = NullString(city)
                    .State = NullString(state)
                    .Zip = NullString(zip)
                    .Telephone = NullString(telephone)
                    .Gender = NullString(gender)
                    .SurveyID = surveyID
                ...
                If Not blnFlag Then
                    tw.WriteLine(fileRecord.PrintHeaderLine)
                    sbTrailer.AppendLine(fileRecord.PrintTrailFileHeaderLine)
                End If
            ...
            Next
            'End TP 20080604
            'For Each row As ExportWPMedicareRFile In Me.mExportWPMedicareRFileCollection
            ...
            '    End If
            'Next
            Dim trailerFN As String = Me.ResultFilePath
...
#Region " Private and Protected Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Private Sub ValidateUserInputFields(ByVal resultRecord As ExportWPMedicareRFile)
    ...
    Private Sub LoadResultResponseCollection()
        ...
        'Me.mExportWPMedicareRFileCollection = New ExportWPMedicareRFileCollection
        ''TODO:  Switch bake to datatable once sort is in the DB.
        'For Each row As DataRow In Me.mResultTable.Rows
        '    Dim exportResultFile As ExportWPMedicareRFile = ExportWPMedicareRFile.NewExportWPMedicareRFile(Me, totalRecordCount)
        ...
        '        .EndPopulate()
        '    End With
        '    Me.mExportWPMedicareRFileCollection.Add(exportResultFile)
        'Next
    End Sub
    ...
    Protected Sub LoadControllerDataSet()
        ...
        Me.mResultConntroller = ExportWPMedicareRFileControllerProvider.Instance.GetResultFileDataSet(Me.mExportGroupID, Me.mLogFileID, Me.mOrigLogFileID, Me.MarkSubmitted, Me.mRerunUsingLogDates, Me.m2401StartDate, Me.m2401EndDate, Me.mActiveOnly)
    End Sub
    ...
    Private Function NullDate(ByVal obj As Object) As Nullable(Of Date)
        ...
        Return retval
    End Function
    Private Function NullString(ByVal obj As Object) As String
