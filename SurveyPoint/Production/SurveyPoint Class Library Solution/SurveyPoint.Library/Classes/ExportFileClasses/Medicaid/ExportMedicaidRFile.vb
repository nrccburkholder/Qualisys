...
Public Interface IExportMedicaidRFileID
    Property ExportMedicaidRFileID() As Integer
End Interface

''' <summary>This object represents a record for the answer file.</summary>
''' <CreatedBy>Tony Piccoli</CreatedBy>
''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
Public Class ExportMedicaidRFile
    Inherits BusinessBase(Of ExportMedicaidRFile)
    Implements IExportMedicaidRFileID

#Region " Private Fields "
    <NotUndoable()> Private mInstanceGuid As Guid = Guid.NewGuid

    'Respondent Answer Fields
    Private mExportMedicaidRFileID As Integer
    ...
    Private mNewMaxEventDate As Nullable(Of Date) = Nothing

    'Passed In fields
    Private mTotalRecordCount As Integer

    Private mParent As ExportMedicaidRFileController
#End Region
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportMedicaidRFileID() As Integer Implements IExportMedicaidRFileID.ExportMedicaidRFileID
        Get
            Return Me.mExportMedicaidRFileID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportMedicaidRFileID Then
                mExportMedicaidRFileID = value
                PropertyHasChanged("ExportMedicaidRFileID")
            End If
        End Set
    End Property
...
#Region " FieldPropeties "
    ...
    Public Property MaxEventDate() As Nullable(Of Date)
        ...
        End Set
    End Property
    'New Max Event Date properties
    Public Property NewMaxEventDate() As Nullable(Of Date)
        Get
            Return Me.mNewMaxEventDate
        End Get
        Set(ByVal value As Nullable(Of Date))
            Me.mNewMaxEventDate = value
            PropertyHasChanged("NewMaxEventDate")
        End Set
    End Property
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public ReadOnly Property ParentController() As ExportMedicaidRFileController
        Get
            Return Me.mParent
        End Get
    End Property
...
#Region " Read Only Display Properties "
    ...
    Public ReadOnly Property Hra_Begin_Date() As String
        Get
            If Me.mMaxEventDate.HasValue Then
                Dim dteString As String = Format(Me.mNewMaxEventDate.Value, "yyyyMMdd")
                Return charString(dteString, 8)
            Else
                Return charString("", 8)
            End If
    ...
    Public ReadOnly Property Mem_Id() As String
        ...
        End Get
    End Property
    ''' <summary>Added 1/18/12.</summary>
    ''' <CreatedBy>Michael Louthan</CreatedBy>
    ''' <RevisionList><list type="table">
    ''' <listheader>
    ''' <term>Date Modified - Modified By</term>
    ''' <description>Description</description></listheader>
    ''' <item>
    ''' <term>20120118 - Michael Louthan</term>
    ''' <description>respondent property.
    ''' </description>
    ''' </item>
    ''' <item>
    ''' <term>	</term>
    ...
    Public ReadOnly Property RiskScore() As String
        Get
            If Me.mRespondentProperties.ContainsKey("Risk_Level") Then
                Dim risk_score As String = CStr(Me.mRespondentProperties("Risk_Level"))
                If risk_score.Length > 5 Then
                    risk_score = risk_score.Substring(risk_score.Length - 5)
                End If
                Return PadCharString(PadCharString(risk_score.ToString, 3, "0"c, PadDirection.Left), 5, " "c, PadDirection.Left)
            Else
                Return charString("", 5)
            End If
        End Get
    ...
    Public ReadOnly Property Pra_Risk_Score() As String
        Get
            ...
            If Me.mRespondentProperties.ContainsKey("PIE_SCORE") Then
                riskScore = CStr(CLng(CStr(Me.mRespondentProperties("PIE_SCORE"))))
            End If
            riskScore = PadCharString(riskScore, 7, "0"c, PadDirection.Right)
            Return charString(riskScore, 7)
        End Get
    End Property
...
#Region " Constructors "
    Protected Sub New(ByVal parent As ExportMedicaidRFileController, ByVal totalRecordCount As Integer)
        Me.CreateNew()
        Me.mParent = parent
...
#Region " Factory Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicaidRFile(ByVal parent As ExportMedicaidRFileController, ByVal totalRecordCount As Integer) As ExportMedicaidRFile
        'TODO:  Overload constructor.
        Return New ExportMedicaidRFile(parent, totalRecordCount)
    End Function
...
#Region " Public Methods "
    ...
    Public Function PrintLine() As StringBuilder
        ...
        sb.Append(PadCharString("", 15, " "c, PadDirection.Left))
