...
Public Interface IExportMedicaidFileID
    Property ExportMedicaidFileID() As Integer
End Interface
...
Public Class ExportMedicaidFile
    Inherits BusinessBase(Of ExportMedicaidFile)
    Implements IExportMedicaidFileID
...
#Region " Private Fields "
    ...
    Private mQuestionFileController As ExportMedicaidQFileController
    Private mResultFileController As ExportMedicaidRFileController
    Private mExportMedicaidFileID As Integer
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportMedicaidFileID() As Integer Implements IExportMedicaidFileID.ExportMedicaidFileID
        Get
            Return Me.mExportMedicaidFileID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportMedicaidFileID Then
                mExportMedicaidFileID = value
                PropertyHasChanged("ExportMedicaidFileID")
            End If
        End Set
    End Property
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Protected Property QuestionFileController() As ExportMedicaidQFileController
        Get
            If Me.mQuestionFileController Is Nothing Then
                Me.mQuestionFileController = ExportMedicaidQFileController.NewExportMedicaidQFileController(Me, Me.mExportLogFile.ExportGroupID, Me.mExportLogFile.QuestionFileName)
            End If
            Return Me.mQuestionFileController
        End Get
        'Set should only be used for memory release.
        Private Set(ByVal value As ExportMedicaidQFileController)
...
#Region " Factory Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicaidFile() As ExportMedicaidFile
        Return New ExportMedicaidFile
    End Function
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicaidFile(ByVal eg As ExportGroup, ByVal userID As Integer, ByVal userName As String, ByVal markSubmitted As Boolean, ByVal ActiveOnly As Boolean) As ExportMedicaidFile
        Dim newObject As ExportMedicaidFile = New ExportMedicaidFile(eg, userID, userName, markSubmitted, ActiveOnly)
        Return newObject
    End Function
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicaidFileFromRerun(ByVal logFileID As Integer, ByVal userID As Integer, ByVal userName As String, ByVal markSubmitted As Boolean, ByVal start2401Date As Nullable(Of Date), ByVal end2401Date As Nullable(Of Date), ByVal ActiveOnly As Boolean) As ExportMedicaidFile
        Dim newObject As ExportMedicaidFile = New ExportMedicaidFile(logFileID, userID, userName, markSubmitted, start2401Date, end2401Date, ActiveOnly)
        Return newObject
    End Function
#End Region
...
#Region " Data Access "
    ...
    Public Sub Mark2401EventForLogFile()
        If Me.mExportLogFile.MarkSubmitted Then
            ExportMedicaidFileProvider.Instance.Mark2401ForLog(Me.mExportLogFile.ExportLogFileID)
        End If
    End Sub
#End Region
