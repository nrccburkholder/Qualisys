...
Public Interface IExportMedicaidRFileControllerID
    Property ExportMedicaidRFileControllerID() As Integer
End Interface
...
Public Class ExportMedicaidRFileController
    Inherits BusinessBase(Of ExportMedicaidRFileController)
    Implements IExportMedicaidRFileControllerID

#Region " Private Fields "
    <NotUndoable()> Private mInstanceGuid As Guid = Guid.NewGuid

    Private mExportMedicaidRFileCollection As ExportMedicaidRFileCollection
    Private mResultFileExported As Boolean = False
    Private mMarkSubmitted As Boolean
    Private mExportMedicaidRFileControllerID As Integer
...
#Region " Public Properties "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Property ExportMedicaidRFileControllerID() As Integer Implements IExportMedicaidRFileControllerID.ExportMedicaidRFileControllerID
        Get
            Return Me.mExportMedicaidRFileControllerID
        End Get
        Protected Set(ByVal value As Integer)
            If Not value = mExportMedicaidRFileControllerID Then
                mExportMedicaidRFileControllerID = value
                PropertyHasChanged("ExportMedicaidRFileControllerID")
            End If
        End Set
    End Property
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public ReadOnly Property ResultFileCollection() As ExportMedicaidRFileCollection
        Get
            Return Me.mExportMedicaidRFileCollection
        End Get
    End Property
...
#Region " Constructors "
    ...
    Protected Sub New(ByVal parent As ExportMedicaidFile, ByVal ExportLogFileID As Integer, ByVal origLogFileID As Integer, ByVal exportGroupID As Integer, _
...
#Region " Factory Methods "
    ...
    ''' <returns>ExportMedicaidRFileController</returns>
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Public Shared Function NewExportMedicaidRFileController(ByVal parent As ExportMedicaidFile, ByVal exportFileID As Integer, _
    ...
    ByVal startDate2401 As Nullable(Of Date), ByVal endDate2401 As Nullable(Of Date), ByVal resultFilePath As String, ByVal ActiveOnly As Boolean) As ExportMedicaidRFileController
        'Dim totalRespondents As Long = ExportMedicaidRFileController.GetNumberOfRespondentsByExportGroup(exportGroupID, exportFileID, origLogFileID, markSubmitted, rerunUserLogdates, startDate2401, endDate2401)
        ...
        'End If
        Dim resultController As ExportMedicaidRFileController = New ExportMedicaidRFileController(parent, exportFileID, origLogFileID, exportGroupID, markSubmitted, rerunUserLogdates, startDate2401, endDate2401, resultFilePath, ActiveOnly)
    ...
    Public Shared Function GetNumberOfRespondentsByExportGroup(ByVal exportGroupID As Integer, ByVal logFileID As Integer, ByVal origLogFileID As Integer, ByVal markSubmitted As Boolean, ByVal rerunUsingLogDates As Boolean, ByVal startDate2401 As Nullable(Of Date), ByVal endDate As Nullable(Of Date), ByVal ActiveOnly As Boolean) As Long
        Return ExportMedicaidRFileControllerProvider.Instance.GetNumberOfRespondentsForExportGroup(exportGroupID, logFileID, origLogFileID, markSubmitted, rerunUsingLogDates, startDate2401, endDate, ActiveOnly)
    End Function
#End Region
...
#Region " Public Methods "
    ...
    Public Function PrintFile() As Integer
        ...
        Me.mParent.RaiseProgressMessage(51, "Result File Printing", False)
        ...
        Try
            ...
            Dim fileRecord As ExportMedicaidRFile
            ...
            Dim newMaxDate As Nullable(Of Date) = Nothing
            ...
            For Each row As Data.DataRow In Me.mResultConntroller.Tables("RespondentAnswers").Rows
                ...
                If currentRespondentID = 0 OrElse respondentID <> currentRespondentID Then
                    ...
                    End If
                    If Not newMaxDate.HasValue OrElse CDate(maxDateRow("OtherMaxEventDate")).CompareTo(newMaxDate) = 1 Then
                        newMaxDate = CDate(maxDateRow("OtherMaxEventDate"))
                    End If
                ...
                fileRecord = ExportMedicaidRFile.NewExportMedicaidRFile(Me, totalRecordCount)
                With fileRecord
                    .BeginPopulate()
            ...
            Next
            'End TP 20080604
            'For Each row As ExportMedicaidRFile In Me.mExportMedicaidRFileCollection
...
#Region " Private and Protected Methods "
    ...
    ''' <CreatedBy>Tony Piccoli</CreatedBy>
    ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
    Private Sub ValidateUserInputFields(ByVal resultRecord As ExportMedicaidRFile)
    ...
    Private Sub LoadResultResponseCollection()
        ...
        'Me.mExportMedicaidRFileCollection = New ExportMedicaidRFileCollection
        ''TODO:  Switch bake to datatable once sort is in the DB.
        'For Each row As DataRow In Me.mResultTable.Rows
        '    Dim ExportMedicaidRFile As ExportMedicaidRFile = ExportMedicaidRFile.NewExportMedicaidRFile(Me, totalRecordCount)
        '    With ExportMedicaidRFile
        '        .BeginPopulate()
        '        .RespondentID = CInt(row("RespondentID"))
        '        .ClientID = CInt(row("ClientID"))
        ...
        '        .EndPopulate()
        '    End With
        '    Me.mExportMedicaidRFileCollection.Add(ExportMedicaidRFile)
        'Next
    End Sub
    ...
    Protected Sub LoadControllerDataSet()
        ...
        Me.mResultConntroller = ExportMedicaidRFileControllerProvider.Instance.GetResultFileDataSet(Me.mExportGroupID, Me.mLogFileID, Me.mOrigLogFileID, Me.MarkSubmitted, Me.mRerunUsingLogDates, Me.m2401StartDate, Me.m2401EndDate, Me.mActiveOnly)
    End Sub
