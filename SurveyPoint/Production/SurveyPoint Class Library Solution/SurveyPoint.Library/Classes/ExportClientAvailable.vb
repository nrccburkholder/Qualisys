...
Public Interface IExportClientAvailable
    Property ClientID() As Integer
End Interface

''' <summary></summary>
''' <CreatedBy></CreatedBy>
''' <RevisionList><list type="table"><listheader><term>2008-02-25 - Steve Kennedy</term><description>Renamed Class From AvailableExportClient to ExportClientAvailable to maintain naming consistancy.</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>

<Serializable()> _
Public Class ExportClientAvailable

    Inherits BusinessBase(Of ExportClientAvailable)
    Implements IExportClientAvailable
...
#Region " Public Properties "
    Public Property ClientID() As Integer Implements IExportClientAvailable.ClientID
        Get
            Return mClientID
        End Get
...
#Region " Factory Methods "
    Public Shared Function NewClient() As ExportClientAvailable
        Return New ExportClientAvailable
    End Function


    Public Shared Function GetBySurveyID(ByVal SurveyID As Integer) As ExportClientAvailableCollection
        Return ExportClientAvailableProvider.Instance.GetBySurveyID(SurveyID)
    End Function
    Public Shared Function GetClientByClientID(ByVal clientID As Integer) As ExportClientAvailable
        Return ExportClientAvailableProvider.Instance.GetClientByClientID(clientID)
    End Function
    'TP 10/16/2008 Used in Template Importer to retrieve list of all clients.
    Public Shared Function GetAllClientList() As ExportClientAvailableCollection
        Return ExportClientAvailableProvider.Instance.SelectAllClients()
    End Function
#End Region
