...
Public Interface IVRTDispositionTVX
    Property VRTID() As Integer
End Interface

<Serializable()> _
Public Class VRTDispositionTVX
    Inherits BusinessBase(Of VRTDispositionTVX)
    Implements IVRTDispositionTVX
...
#Region " Public Properties "
    Public Property VRTID() As Integer Implements IVRTDispositionTVX.VRTID
        Get
            Return mVRTID
        End Get
...
#Region " Factory Methods "
    Public Shared Function NewVRTDispositionTVX(ByVal respID As Integer, ByVal callOutcome As String, _
    ByVal dateTimeStamp As String, ByVal CallType As String) As VRTDispositionTVX
        Return New VRTDispositionTVX(respID, callOutcome, dateTimeStamp, CallType)
    End Function
#End Region
...
#Region " Public Methods "
    ...
    Private Function SPImportLine(ByVal index As Integer) As String
        Dim RetVal As String = "'"
        Try
            RetVal = DataProviders.VRTDispositionTVXProvider.Instance.ImportVRTDisposition(index, Me)
        Catch ex As Exception
