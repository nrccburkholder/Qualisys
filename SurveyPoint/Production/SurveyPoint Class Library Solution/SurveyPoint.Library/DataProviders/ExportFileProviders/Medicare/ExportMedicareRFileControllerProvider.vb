Namespace DataProviders
    ...
    Public MustInherit Class ExportMedicareRFileControllerProvider

#Region " Singleton Implementation "
        Private Shared mInstance As ExportMedicareRFileControllerProvider
        Private Const mProviderName As String = "ExportMedicareRFileControllerProvider"
        ''' <summary>Retrieves the instance of the Data provider class that will implement the astract methods.</summary>
        ''' <value></value>
        ''' <CreatedBy>Tony Piccoli</CreatedBy>
        ''' <RevisionList><list type="table"><listheader><term>Date Modified - Modified By</term><description>Description</description></listheader><item><term></term><description></description></item><item><term></term><description></description></item></list></RevisionList>
        Public Shared ReadOnly Property Instance() As ExportMedicareRFileControllerProvider
            Get
                If mInstance Is Nothing Then
                    mInstance = DataProviderFactory.CreateInstance(Of ExportMedicareRFileControllerProvider)(mProviderName)
                End If
