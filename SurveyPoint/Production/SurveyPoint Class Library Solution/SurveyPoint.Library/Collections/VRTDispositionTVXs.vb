...
<Serializable()> _
Public Class VRTDispositionTVXs
    Inherits BusinessListBase(Of VRTDispositionTVXs, VRTDispositionTVX)
    Dim msgs As New StringBuilder()

    Public Function ProcessVRTDispositionTVXImport() As StringBuilder
        Try
