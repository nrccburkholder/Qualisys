...
Friend Class ExportMedicaidQFileProvider
    Inherits Nrc.SurveyPoint.Library.DataProviders.ExportMedicaidQFileProvider
...
#Region " SPU_ExportGroup Procs "
    ...
    Private Function PopulateQuestion(ByVal questionController As ExportMedicaidQFileController, ByVal rdr As SafeDataReader) As ExportMedicaidQFile
        Dim newObject As ExportMedicaidQFile = ExportMedicaidQFile.NewExportMedicaidQFile
        Dim privateInterface As IExportMedicaidQFileID = newObject
    ...
    Public Overrides Function CreateQuestionFileCollection(ByVal questionController As ExportMedicaidQFileController, ByVal exportGroupID As Integer) As ExportMedicaidQFileCollection
        Dim cmd As DbCommand = Db.GetStoredProcCommand(SP.CreateQuestionFile, exportGroupID)
        Dim list As ExportMedicaidQFileCollection = New ExportMedicaidQFileCollection
