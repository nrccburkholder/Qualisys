...
Friend Class ExportMedicare2012QFileProvider
    Inherits Nrc.SurveyPoint.Library.DataProviders.ExportMedicare2012QFileProvider
...
#Region " SPU_ExportGroup Procs "
    ...
    Private Function PopulateQuestion(ByVal questionController As ExportMedicare2012QFileController, ByVal rdr As SafeDataReader) As ExportMedicare2012QFile
        Dim newObject As ExportMedicare2012QFile = ExportMedicare2012QFile.NewExportMedicare2012QFile
        Dim privateInterface As IExportMedicare2012QFileID = newObject
    ...
    Public Overrides Function CreateQuestionFileCollection(ByVal questionController As ExportMedicare2012QFileController, ByVal exportGroupID As Integer) As ExportMedicare2012QFileCollection
        Dim cmd As DbCommand = Db.GetStoredProcCommand(SP.CreateQuestionFile, exportGroupID)
        Dim list As ExportMedicare2012QFileCollection = New ExportMedicare2012QFileCollection
