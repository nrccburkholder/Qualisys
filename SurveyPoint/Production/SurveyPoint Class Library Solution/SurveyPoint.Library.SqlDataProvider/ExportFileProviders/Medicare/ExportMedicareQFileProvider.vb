...
Friend Class ExportMedicareQFileProvider
    Inherits Nrc.SurveyPoint.Library.DataProviders.ExportMedicareQFileProvider
...
#Region " SPU_ExportGroup Procs "
    ...
    Private Function PopulateQuestion(ByVal questionController As ExportMedicareQFileController, ByVal rdr As SafeDataReader) As ExportMedicareQFile
        Dim newObject As ExportMedicareQFile = ExportMedicareQFile.NewExportMedicareQFile
        Dim privateInterface As IExportMedicareQFileID = newObject
    ...
    Public Overrides Function CreateQuestionFileCollection(ByVal questionController As ExportMedicareQFileController, ByVal exportGroupID As Integer) As ExportMedicareQFileCollection
        Dim cmd As DbCommand = Db.GetStoredProcCommand(SP.CreateQuestionFile, exportGroupID)
        Dim list As ExportMedicareQFileCollection = New ExportMedicareQFileCollection
