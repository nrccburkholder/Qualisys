...
Friend Class VRTDispositionTVXProvider
    Inherits Nrc.SurveyPoint.Library.DataProviders.VRTDispositionTVXProvider
...
#Region " SP Declarations "
    Private NotInheritable Class SP
        Private Sub New()
        End Sub
        Public Const ImportVRTDisposition As String = "dbo.VRT_ImportDispositionTVX"
    End Class
#End Region
...
#Region " SPTI_DeDupRule Procs "
    ...
    Public Overrides Function ImportVRTDisposition(ByVal index As Integer, ByVal instance As VRTDispositionTVX) As String
