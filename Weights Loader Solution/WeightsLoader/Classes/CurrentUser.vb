...
Public NotInheritable Class CurrentUser
    ...
    Public Shared ReadOnly Property HasWeightsLoaderAccess() As Boolean
        Get
            If Member Is Nothing Then
                Return False
            Else
                Return Member.HasAccessToApplication("Weights Loader")
            End If
        End Get
    End Property

    Public Shared ReadOnly Property IsWeightTypesManager() As Boolean
        Get
            Return Member.HasMemberPrivilege("Weights Loader", "Weight Types Manager")
        End Get
    End Property
