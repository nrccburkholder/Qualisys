...
#Region "private members"
    ...
    Private mSearchStatus As USPSAddressUpdateNavigator.SearchTypes = USPSAddressUpdateNavigator.SearchTypes.Unprocessed
...
#Region "event handlers"
    ...
    Private Sub gvPartialMatches_CustomDrawCell(sender As Object, e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs) Handles gvPartialMatches.CustomDrawCell
        ...
        If e.Column.FieldName = "Updated" Or e.Column.FieldName = "Ignored" Then
            ...
            Select Case status
                Case 1
                    e.Appearance.BackColor = Color.FromArgb(248, 248, 248)
                Case Else
    ...
    Public Sub IdleEvent(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        btnUpdate.Enabled = (mSearchStatus = USPSAddressUpdateNavigator.SearchTypes.Unprocessed Or mSearchStatus = USPSAddressUpdateNavigator.SearchTypes.Ignored)
...
#Region "private methods"
    ...
    Private Sub Initialize()
        ...
        LoadData(USPSAddressUpdateNavigator.SearchTypes.Unprocessed, Nothing, Nothing)
        LoadReceiptTypeList()
    ...
    Private Sub SaveData()
        ...
        If IsCheckBoxChecked() Then
            ...
            End Try
        Else
            MsgBox("Nothing marked for updating.", MsgBoxStyle.Exclamation, "USPS Address Updating")
        End If
    ...
    Private Function IsCheckBoxChecked() As Boolean
        ...
        For i As Integer = 0 To dataRowCount - 1
            ...
            Dim targetValue1 As String = gvPartialMatches.GetRowCellValue(i, gvPartialMatches.Columns("Updated")).ToString()
            Dim targetValue2 As String = gvPartialMatches.GetRowCellValue(i, gvPartialMatches.Columns("Ignored")).ToString()

            If isFlaggedForUpdate Or isFlaggedForIgnore Then
