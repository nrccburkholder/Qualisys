...
///<li>4: OUL_R22_RESULT (a Group object) </li>
...
public class OUL_R22_ORDER : AbstractGroup {
	...
	public OUL_R22_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OUL_R22_RESULT), true, false);
...
get{
	...
	///<summary>
	/// Returns OUL_R22_RESULT (a Group object) - creates it if necessary
	///</summary>
	public OUL_R22_RESULT RESULT { 
get{
