...
///<li>1: OML_O33_TIIMING (a Group object) </li>
...
public class OML_O33_ORDER : AbstractGroup {
	...
	public OML_O33_ORDER(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      ...
	      this.add(typeof(OML_O33_TIIMING), true, false);
...
get{
	...
	///<summary>
	/// Returns OML_O33_TIIMING (a Group object) - creates it if necessary
	///</summary>
	public OML_O33_TIIMING TIIMING { 
get{
