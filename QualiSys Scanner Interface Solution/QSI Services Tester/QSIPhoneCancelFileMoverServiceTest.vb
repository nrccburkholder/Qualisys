...
Public Class QSIPhoneCancelFileMoverServiceTest
...
#Region "Run As Service Button Events"
    ...
    Private Sub StartButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles StartButton.Click
        ...
        Try
            ...
            ServiceTimer.Interval = 30000 'always start up in 30 seconds, rather than worrying about matching logic to run every 24 hours at 8:30 am
        ...
        Catch ex As Exception
            ...
            LogEvent("The QSI Phone Vendor File Mover Service was unable to start!", ex, EventLogEntryType.Error)
