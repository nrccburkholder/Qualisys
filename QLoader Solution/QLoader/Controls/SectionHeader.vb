...
#Region " Constructors "
    ...
    Public Sub New()
        ...
        AddHandler Microsoft.Win32.SystemEvents.UserPreferenceChanged, AddressOf OnColorSchemeChanged
    End Sub
...
#Region " Private Methods "
    ...
    Private Sub OnColorSchemeChanged(ByVal sender As Object, ByVal e As Microsoft.Win32.UserPreferenceChangedEventArgs)
        'Reset the colors
        InitBrush()
    End Sub
    ...
    Private Sub InitBrush()
        ...
        If Me.mUseThemeColors Then
            mBrush = New LinearGradientBrush(Me.DisplayRectangle, ProfessionalColors.MenuStripGradientEnd, ProfessionalColors.MenuStripGradientBegin, LinearGradientMode.Vertical)
            PENTOP = New Pen(ProfessionalColors.ToolStripBorder)
            PENBOTTOM = New Pen(ProfessionalColors.ToolStripBorder)
        Else
