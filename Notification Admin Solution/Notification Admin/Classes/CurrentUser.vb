    ...
    Public Shared ReadOnly Property HasApplicationAccess() As Boolean
        Get
            If Member Is Nothing Then
                Return False
            Else
                Return Member.HasAccessToApplication("Notification Admin")
            End If
        End Get
    End Property

    Public Shared ReadOnly Property IsNotificationTest() As Boolean
        Get
            Return Member.HasMemberPrivilege("Notification Admin", "Access Notification Test") OrElse Member.HasMemberPrivilege("Notification Admin", "Administrator")
        End Get
    End Property
