...
#Region " Command Enabled Properties "
    ...
    Private Property IsEditOUHEnabled() As Boolean
        Get
            Return Me.EditOUHButton.Enabled
        End Get
        Set(ByVal value As Boolean)
            Me.EditOUHButton.Enabled = value
...
#Region " Control Event Handlers "
    ...
    Private Sub EditOUHButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditOUHButton.Click
        Me.EditOUHCommand()
    End Sub
...
#Region " Private Methods "
    ...
    Private Sub EditOUHCommand()
        If Me.SelectedMember IsNot Nothing Then
            Dim frm As New MemberOUHDialog(Me.SelectedMember)
            frm.ShowDialog()
        End If
    End Sub
