...
#Region " Command Enabled Properties "
    ...
    Private Property IsEditOUHEnabled() As Boolean
        Get
            Return Me.GroupOUHButton.Enabled
        End Get
        Set(ByVal value As Boolean)
            Me.GroupOUHButton.Enabled = value
            Me.EditOUHMenuItem.Enabled = value
        End Set
    End Property
...
#Region " Control Event Handlers "
    ...
    Private Sub EditOUHMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditOUHMenuItem.Click
        Me.EditOUHCommand()
    End Sub
    ...
    Private Sub GroupOUHButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupOUHButton.Click
        Me.EditOUHCommand()
    End Sub
...
#Region " Private Methods "
    ...
    Private Sub EditOUHCommand()
        If Me.SelectedGroup IsNot Nothing Then
            Dim frm As New GroupOUHDialog(Me.SelectedGroup)
            frm.ShowDialog()
        End If
    End Sub
    ...
    Private Sub ToggleEnabledCommands()
        ...
        Me.IsEditOUHEnabled = (rowCount = 1)
