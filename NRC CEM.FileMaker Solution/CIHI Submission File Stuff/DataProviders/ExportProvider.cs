...
namespace ConsoleApplication1.DataProviders
{
    internal static class ExportProvider
    {
        ...
        internal static DataSet SelectSubmission_QuestionnaireCycle(int id, string facilityNum)
        {
            SqlParameter[] param = new SqlParameter[] { new SqlParameter("@ID", id), new SqlParameter("@FacilityNum", facilityNum) };
