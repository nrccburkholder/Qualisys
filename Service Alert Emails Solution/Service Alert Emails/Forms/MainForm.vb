...
Public Class MainForm
    ...
    Private Sub InitializeUI()
        ...
        If CurrentUser.IsComputerAdmin Then
            mFolderNavigator = New FolderNavigator
            mFolderSection = New FolderSection
            mUIRelations.Add(Me.MyComputerTab, New UIRelation(mFolderNavigator, mFolderSection))
        Else
            MultiPane.Tabs.Remove(MyComputerTab)
        End If

        If CurrentUser.IsReportViewer Then
            mReportNavigator = New ReportNavigator
            mReportSection = New ReportSection
            mUIRelations.Add(Me.ReportsTab, New UIRelation(mReportNavigator, mReportSection))
        Else
            MultiPane.Tabs.Remove(ReportsTab)
        End If
