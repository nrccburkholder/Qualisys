...
#End Region
    ...
    Private Sub Frequencies_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pnlBaseComparisonControl.Caption = "Frequencies"
        MyBase.mActiveQuery = New ComparisonDataQuery(ComparisonDataQuery.enuReportType.Frequencies)
