...
#Region "Public Methods"
    Public Sub ListBoxDataSource(ByVal listBoxElements As Object, ByVal displayMember As String)
        mListBox.DataSource = Nothing
        mListBox.DataSource = listBoxElements
        mListBox.DisplayMember = displayMember
    End Sub
#End Region
...
#Region " Private Methods "
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        Select Case Me.mInputType
            ...
            Case InputType.ListBox
                If mListBox.SelectedIndex = -1 Then
                    MessageBox.Show("You must make a selection.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    Return
                End If
                Me.mInput = mListBox.SelectedItem
        End Select
