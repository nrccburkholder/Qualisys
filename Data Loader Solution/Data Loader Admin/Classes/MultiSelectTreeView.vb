...
#Region " Base Class Overrides "
    ''Commented out by Arman Mnatsakanyan
    '' We do not need Ctrl+A to select every node in the tree.
...
#Region "Public methods"
    ...
    Public Sub DeselectNode(ByVal node As TreeNode)
...
#Region " Private Methods "
    ...
    Public Sub DeselectAllSelectedNodes()
