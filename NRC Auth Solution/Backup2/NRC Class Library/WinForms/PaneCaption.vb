        ...
        Private Sub CreateGradientBrushes()
            ...
            If Me.Width > 0 AndAlso Me.Height > 0 Then
                ...
                If Me.mUseThemeColors Then
                    ...
                    mBrushInactive = New LinearGradientBrush(Me.DisplayRectangle, ProColors.OverflowButtonGradientMiddle, ProColors.OverflowButtonGradientEnd, LinearGradientMode.Vertical)
                Else
