...
Public Class EmailFormatter
    ...
    Public Shared Function GetUserListEmail(ByVal usernamelist As Collections.ArrayList) As String
        ...
        html.Write("Below is the list of all of your NRC Health accounts. ")
    ...
    Public Shared Function GetNewAccountEmail(ByVal userName As String, ByVal password As String, ByVal url As String) As String
        ...
        html.Write("<BR>")
        html.Write("<BR>")
        html.Write("You have been set up with access to the NRC Health Reporting Site.  To activate your account click the link below and when prompted enter the user name and password provided in this email. Please bookmark this login screen as a Favorite for easy access in the future. ")
        html.Write("<BR>")
        html.Write("<BR>")
