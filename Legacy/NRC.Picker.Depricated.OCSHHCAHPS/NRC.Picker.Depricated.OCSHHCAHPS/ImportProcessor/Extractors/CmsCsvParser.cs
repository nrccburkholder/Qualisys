                ...
                foreach (var body in engine)
                {
                    if (firstRecord)
                        metadata.Add(
                            ExtractHelper.CreateTransformRow(1,
                                ExtractHelper.CreateFieldElement(ExtractHelper.MonthField, body.Sample_Month ?? -1),
                    ...
                    rows.Add(
                        ExtractHelper.CreateTransformRow(rowCount,
                            ...
                            ExtractHelper.CreateFieldElement(ExtractHelper.MedicalRecordNumberField, body.Patient_ID),
                            ...
                            ExtractHelper.CreateFieldElement(ExtractHelper.LookbackPeriodVisitsField, body.Lookback_Skilled_Visits),
                            ...
                            ExtractHelper.CreateFieldElement(ExtractHelper.HomeHealthVisitTypeField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.AssessmentReasonField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.DischargeDateField, ""),
                            ...
                            ExtractHelper.CreateFieldElement(ExtractHelper.AdmissionSourceIPPSField, ""),
                            ...
                            ExtractHelper.CreateFieldElement(ExtractHelper.AdmissionSourcePyschField, ""),
                            ...
                            ExtractHelper.CreateFieldElement(ExtractHelper.ReferralSourceField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.SkilledNursingField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.PhysicalTherapyField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.HomeHealthAideField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.SocialServiceField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.OccupationalTherapyField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.CompanionHomemakerField, ""),
                            ExtractHelper.CreateFieldElement(ExtractHelper.SpeechTherapyField, ""),
