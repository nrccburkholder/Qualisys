            ...
            foreach (var body in records)
            {
                ...
                rows.Add(
                    ExtractHelper.CreateTransformRow(rowCount,
                        ...
                        ExtractHelper.CreateFieldElement("Lookback Period Visits", GetLookbackSkilledVisits(body.PriorMonth_Skilled_Visits, body.CurrentMonth_Skilled_Visits, isPtct)),
                        ...
                        ExtractHelper.CreateFieldElement("Discharge Date", ExtractHelper.ConvertDateFormat(body.Discharge_Date, isPtct)),
                        ...
                        ExtractHelper.CreateFieldElement("HMO Indicator", ZeroFixup(body.HMO_Indicator, isPtct)),
                        ExtractHelper.CreateFieldElement("Dually eligible for Medicare and Medicaid?", ZeroFixup(body.Dual_eligible, isPtct)),
                        ...
                        ExtractHelper.CreateFieldElement("Surgical Discharge", ZeroFixup(body.Surgical_Discharge, isPtct)),
                        ExtractHelper.CreateFieldElement("End-Stage Renal Disease (ESRD)", ZeroFixup(body.ESRD, isPtct)),
                        ...
                        ExtractHelper.CreateFieldElement("Skilled Nursing", ZeroFixup(body.SN, isPtct)),
                        ExtractHelper.CreateFieldElement("Physical Therapy", ZeroFixup(body.PT, isPtct)),
                        ExtractHelper.CreateFieldElement("Home Health Aide", ZeroFixup(body.HHA, isPtct)),
                        ExtractHelper.CreateFieldElement("Social Service", ZeroFixup(body.Social_Service, isPtct)),
                        ExtractHelper.CreateFieldElement("Occupational Therapy", ZeroFixup(body.OT, isPtct)),
                        ExtractHelper.CreateFieldElement("Companion/Homemaker", body.Comp_Hmkr),
                        ExtractHelper.CreateFieldElement("Speech Therapy", ZeroFixup(body.ST, isPtct)),
