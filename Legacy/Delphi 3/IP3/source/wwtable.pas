...
var i: integer;
begin
   if IndexDefs.count=0 then IndexDefs.update;  { refreshes Index list }
...
begin
   if IndexDefs.count=0 then IndexDefs.update;
end;

procedure TwwTable.InitFieldDefs;
begin
   if Query.Count=0 then inherited InitFieldDefs
   else begin
