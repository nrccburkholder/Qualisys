...
namespace HHCAHPS.ImportProcessorTest
{
    ...
    public class OcsCsvParserTest
    {
        ...
        {
            return OcsPtctCsvParser.Parse(new ClientDetail { CCN = "058110" }, "file.csv", GetSample1File(), false);
        }
        ...
        public void Parse_MissingHeaderHeader_MetadataIsSet()
        {
            ...
            var xml = OcsPtctCsvParser.Parse(new ClientDetail { CCN = "058110" }, "file.csv", fileContents, false);
        ...
        {
            var xml = OcsPtctCsvParser.Parse(new ClientDetail { CCN = "058110" }, "file.csv", "", false);
        }
