...
#Region " Public MustOverride Methods "
        ...
        Public MustOverride Function GetNavigationTreeByUser(ByVal userName As String, ByVal initialDepth As InitialPopulationDepth, ByVal includeGroups As Boolean) As NavigationTree
