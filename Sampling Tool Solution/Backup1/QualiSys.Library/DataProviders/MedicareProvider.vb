...
#End Region
        ...
        Public MustOverride Function GetHistoricAnnualVolume(ByVal MedicareNumber As String, ByVal propSampleDate As Date) As Integer
        Public MustOverride Function GetHistoricRespRate(ByVal MedicareNumber As String, ByVal propSampleDate As Date) As Decimal
        Public MustOverride Function HasHistoricValues(ByVal MedicareNumber As String, ByVal propSampleDate As Date) As Boolean
        ...
        Public MustOverride Sub LogUnlockSample(ByVal medicareNumber As String, ByVal memberId As Integer, ByVal dateUnlocked As Date)
