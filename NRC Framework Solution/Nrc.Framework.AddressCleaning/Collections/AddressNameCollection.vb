...
Public Class AddressNameCollection
    Inherits BusinessListBase(Of AddressNameCollection, AddressName)

#Region " Private Members "

    Private mCountryID As CountryIDs
    Private Const WEB_SERVICE_MAX_RETRIES As Integer = 3
    Private addressCleanRecords As List(Of Object)
    Private nameHint As String = "2"
...
#Region " Base Class Overrides "
    ...
    Protected Overrides Function AddNewCore() As Object
        ...
        Dim newObj As AddressName = AddressName.NewAddressName
        Add(newObj)
        Return newObj
...
#Region " Friend Methods "
    ...
    Friend Sub Clean(ByVal assignIDs As Boolean, ByVal populateGeoCoding As Boolean, ByVal dataFileId As Integer, ByVal propCase As Boolean)
        ...
        For Each addr As AddressName In Me
            ...
            AddPersonatorAddress(addrCount, addr, nameCleaningPrefixes, addressCleanRecords)
            ...
            If addrCount = maxRecords OrElse addrUsed = Count Then
                ...
                UpdatePersonatorAddresses(personatorResponse, populateGeoCoding, dataFileId, propCase)  ' modify UpdateAddress to update name, address and geocode
    ...
    Friend Sub CleanAll(ByVal dataFileID As Integer, ByVal studyID As Integer, ByVal batchSize As Integer, ByRef metaGroups As MetaGroupCollection, ByVal loadDB As LoadDatabases)

        AddressProvider.PersonatorCleanAll(dataFileID, studyID, batchSize, metaGroups, Me, loadDB)
    ...
    Private Function cleanSingleAddress(ByVal assignIDs As Boolean, ByVal forceProxy As Boolean, ByVal populateGeoCoding As Boolean, ByRef addr As AddressName, ByVal dataFileId As Integer) As JObject
        Dim addrCount As Integer = 0
        Dim addrUsed As Integer = 0
        Dim webCallCount As Integer = 0
        Dim maxRecords As Integer = AppConfig.Params("AddressWebServiceMaxRecords").IntegerValue
...
#Region " Private Methods "
    ...
    Private Sub AddPersonatorAddress(ByVal cnt As Integer, ByVal addr As AddressName, ByRef nameCleaningPrefixes As List(Of String), ByRef addressCleanRecords As List(Of Object))
    ...
    Private Sub UpdatePersonatorAddresses(ByVal personatorResponse As JObject, ByVal populateGeoCoding As Boolean, ByVal datafileId As Integer, ByVal propCase As Boolean)
        ...
        For i As Integer = 0 To CInt(personatorResponse.Item("TotalRecords")) - 1
            ...
            Dim addr As AddressName = FindAddress(recordID)
            ...
            UpdatePersonatorAddress(addr, cleanRecord, datafileId)
            UpdatePersonatorName(addr, cleanRecord, propCase)
            If populateGeoCoding Then
                UpdatePersonatorGeoCode(addr, cleanRecord)
            End If
        Next
    ...
    ''' <remarks></remarks>
    Private Function FindAddress(ByVal dbKey As Integer) As AddressName
    ...
    Private Sub UpdatePersonatorAddress(ByRef addr As AddressName, ByRef response As JToken, ByVal datafileId As Integer)
    ...
    Private Sub UpdatePersonatorName(ByVal item As AddressName, ByRef response As JToken, ByVal properCase As Boolean)
    ...
    Private Function ParseSingleAddress(ByRef responses As JObject, ByRef addr As AddressName) As AddressName
    ...
    Private Function CheckForValidSecondAddress(ByVal results As String, ByRef addr As AddressName) As Boolean
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Sub ResendSecondaryAddress(ByRef origAddr As AddressName, ByVal datafileId As Integer)

        'Make clone of the address being passed in
        Dim clonedAddress As AddressName = origAddr.Clone
        ...
        Dim returnedAddress As AddressName = ParseSingleAddress(responseArray, origAddr)
    ...
    Private Sub UpdatePersonatorGeoCode(ByVal addr As AddressName, ByRef response As JToken)
