...
#Region " IsDirty, IsValid "
    ...
    Public Overridable ReadOnly Property IsSavable() As Boolean
        Get
            Return (Me.IsDirty AndAlso Me.IsValid)
        End Get
    End Property
#End Region
...
#Region " ICloneable "
    ...
    Protected Overridable Function GetClone() As Object
        ...
        Return Core.ObjectCloner.Clone(Me)
...
#Region " Data Access "
    ...
    Public Overridable Sub Save()
        ...
        If IsDirty Then
            ...
            For Each child As C In Me.DeletedList
                If child.IsDeleted AndAlso Not child.IsNew Then
                    child.Save()
                End If
            Next
            'Clear the deleted item list
            Me.DeletedList.Clear()

            'Save all others
            For Each child As C In Me
                If child.IsSavable Then child.Save()
            Next
        End If
    End Sub
