Partial Public NotInheritable Class SP
    ...
    Public Const SelectSystematicSamplingOutgo As String = "QCL_GetSystematicSamplingOutgo"
    ...
    Public Const DeleteSystematicOutgo As String = "QCL_DeleteSystematicOutgo"
