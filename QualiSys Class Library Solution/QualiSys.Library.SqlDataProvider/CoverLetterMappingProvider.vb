...
Public Class CoverLetterMappingProvider
    ...
    Private Function PopulateCoverLetterMapping(ByVal rdr As SafeDataReader) As CoverLetterMapping
        ...
        newObject.SampleUnit_name = rdr.GetString("strSampleUnit_nm")
        newObject.CoverLetterItemType_Id = rdr.GetByte("CoverLetterItemType_id")
        newObject.CoverId = rdr.GetInteger("CoverID")
        newObject.CoverLetter_name = rdr.GetString("CoverLetter_dsc")
        newObject.CoverLetterItem_Id = rdr.GetInteger("CoverLetterItem_id")
        newObject.CoverLetterItem_label = rdr.GetString("CoverLetterItem_label")
        newObject.ArtifactPage_Id = rdr.GetInteger("ArtifactPage_id")
        newObject.Artifact_name = rdr.GetString("ArtifactPage_dsc")
        newObject.Artifact_Id = rdr.GetInteger("Artifact_id")
        newObject.Artifact_label = rdr.GetString("Artifact_label")
