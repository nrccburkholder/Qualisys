...
#End Region
        ...
        Public MustOverride Function SelectSystematicSamplingOutgo(ByVal sampleSetID As Integer, ByVal surveyId As Integer, samplingDate As Date) As Dictionary(Of Integer, Dictionary(Of String, Object))
