...
SELECT Disposition_id, strDispositionLabel, Action_id, HCAHPSValue, strReportLabel, HCAHPSHierarchy, MustHaveResults
...
INSERT INTO [dbo].Disposition (strDispositionLabel, Action_id, HCAHPSValue, strReportLabel, HCAHPSHierarchy, MustHaveResults)
VALUES (@strDispositionLabel, @Action_id, @HCAHPSValue, @strReportLabel, @HCAHPSHierarchy, @MustHaveResults)
