...
GO
---------------------------------------------------------------------------------------
--QSL_SelectTransferResultsNavigatorTree
---------------------------------------------------------------------------------------
IF OBJECT_ID(N'[dbo].[QSL_SelectTransferResultsNavigatorTree]') IS NOT NULL 
    DROP PROCEDURE [dbo].[QSL_SelectTransferResultsNavigatorTree]
GO
