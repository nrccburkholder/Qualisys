...
INSERT INTO #TreeData (Vendor_ID, Vendor_Nm, DataLoad_ID, DisplayName, SurveyDataLoad_ID, Survey_ID, strSurvey_Nm, bitSDLHasErrors)
SELECT vd.Vendor_ID, vd.Vendor_Nm, dl.DataLoad_ID, dl.DisplayName, sl.SurveyDataLoad_ID, sl.Survey_ID, sd.strSurvey_Nm, sl.bitHasErrors
...
--Return the data set
SELECT td.Vendor_ID, td.Vendor_Nm, td.DataLoad_ID, td.DisplayName, bitDLHasSurveyErrors, bitDLHasBadLithos, td.SurveyDataLoad_ID, td.Survey_ID, td.strSurvey_Nm, td.bitSDLHasErrors
