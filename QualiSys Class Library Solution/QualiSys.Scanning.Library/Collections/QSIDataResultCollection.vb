    ...
    Public ReadOnly Property STRResult(ByVal qstnCore As Integer, ByVal width As Integer, ByVal readMethodId As Integer) As String
        Get
            ...
            If readMethodId = 1 Then
                ...
                For Each result As QSIDataResult In Me
                    If result.QstnCore = qstnCore Then
                        If result.ResponseValue = -9 Or result.ResponseValue = -6 Or result.ResponseValue = -5 Then
            ...
            Else
                ...
                For Each result As QSIDataResult In Me
                    If result.QstnCore = qstnCore Then
                        ...
                        ElseIf result.ResponseValue = -6 Then
                            'For don't know response the STR file just gets spaces
                            strResults = strResults.PadLeft(width, " "c)
                        ElseIf result.ResponseValue = -5 Then
                            'For refused response the STR file just gets spaces
                            strResults = strResults.PadLeft(width, " "c)
                        Else
