...
#End Region
    ...
    Public MustOverride Function GeneratePhoneVendorCancelFile(ByVal vendorFileId As Integer) As VendorPhoneFile_DataCollection
    Public MustOverride Sub MarkPhoneVendorCancelFileSent(ByVal Vendor_id As Integer)
End Class
