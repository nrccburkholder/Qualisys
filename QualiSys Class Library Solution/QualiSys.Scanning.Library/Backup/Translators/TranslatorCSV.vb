...
#Region "Public Methods"
    ...
    Public Overrides Function Translate(ByVal queueFile As QueuedTransferFile) As DataLoad
        ...
        Dim table As DataTable = TranslatorProvider.Instance.GetDataTableCSV(queueFile)
    ...
    Private Function PopulateDataSet_1_0(ByVal queueFile As QueuedTransferFile, ByVal table As DataTable) As DataSet
        ...
        For Each row As DataRow In table.Rows
            ...
            If Not IsDataRowEmpty(row) Then
                ...
                If Not Date.TryParse(row("DispositionDate").ToString, dispoDate) Then
                    loadSet.Tables("Disposition").Rows.Add(lithoCode, row("DispositionCode"), DBNull.Value, row("IsFinal"))
                Else
                    loadSet.Tables("Disposition").Rows.Add(lithoCode, row("DispositionCode"), dispoDate, row("IsFinal"))
                End If
