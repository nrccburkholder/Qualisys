...
#Region " Friend Methods "
    ...
    Friend Sub SaveToQualiSys(ByVal userName As String, ByVal commentFileName As String, ByRef qtyCommentRowsInFile As Integer, ByVal noResponseChar As String, ByVal skipResponseChar As String)
        ...
        'Start a transaction
        Dim trans As DbTransaction = LithoCodeProvider.Instance.BeginTransaction
        ...
        Try
            ...
            If Dispositions.DoesFinalExist AndAlso Not IsUndeliverable() Then
                If DoResultsExist(noResponseChar) Then
                    ...
                    For Each result As QuestionResult In QuestionResults
                        If result.ErrorId <> TransferErrorCodes.IgnoreQstnCore AndAlso Not String.IsNullOrEmpty(result.ResponseVal) Then
                            If Integer.TryParse(result.GetQualiSysResponseValue(noResponseChar, skipResponseChar), tryInt) Then
    ...
    Friend Function IsDispositionOnly(ByVal noResponseChar As String) As Boolean

        Return (Dispositions.Count > 0 AndAlso QuestionResults.ValidResultCount(noResponseChar) = 0 AndAlso Comments.Count = 0 AndAlso HandEntries.Count = 0 AndAlso PopMappings.Count = 0)
...
#Region "Private Methods"
    ...
    Private Function DoResultsExist(ByVal noResponseChar As String) As Boolean

        Return (QuestionResults.HasValidResults(noResponseChar) OrElse Comments.Count > 0 OrElse HandEntries.Count > 0 OrElse PopMappings.Count > 0)
