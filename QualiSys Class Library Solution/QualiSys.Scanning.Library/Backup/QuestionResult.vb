...
#Region " Friend Methods "
    ...
    Friend Function IsValidQualiSysResult(ByVal noResponseChar As String) As Boolean

        Dim tryInt As Integer

        If Not String.IsNullOrEmpty(ResponseVal) AndAlso ResponseVal <> "-9" AndAlso (ResponseVal.ToUpper = noResponseChar OrElse Integer.TryParse(ResponseVal, tryInt)) AndAlso ErrorId = TransferErrorCodes.None Then
            Return True
        Else
            Return False
        End If
    ...
    Friend Function GetQualiSysResponseValue(ByVal noResponseChar As String, ByVal skipResponseChar As String) As String
