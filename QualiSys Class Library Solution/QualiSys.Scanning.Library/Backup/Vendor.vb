...
#Region "Validation Methods"
    ...
    Private Function ValidateRepsonseCharsIsUnique(ByVal target As Object, ByVal e As Validation.RuleArgs) As Boolean
        ...
        If e.PropertyName = "NoResponseChar" Then
            If Me.NoResponseChar = Me.SkipResponseChar OrElse Me.NoResponseChar = Me.MultiRespItemNotPickedChar Then
                e.Description = "Response Characters must be unique!"
                Return False
            End If
        ElseIf e.PropertyName = "SkipResponseChar" Then
            If Me.NoResponseChar = Me.SkipResponseChar OrElse Me.SkipResponseChar = Me.MultiRespItemNotPickedChar Then
                e.Description = "Response Characters must be unique!"
                Return False
            End If
        Else
            If Me.NoResponseChar = Me.MultiRespItemNotPickedChar OrElse Me.SkipResponseChar = Me.MultiRespItemNotPickedChar Then
                e.Description = "Response Characters must be unique!"
                Return False
            End If
        End If
