Imports Nrc.QualiSys.Pervasive.Library.DataProvider
...
#Region " Public Methods "
        ...
        Public Shared Function GetByUser(ByVal userName As String, ByVal depth As InitialPopulationDepth, ByVal includeGroups As Boolean, ByVal dataFileState As DataFileStates) As NavigationTree

            Return NavigationProvider.Instance.GetNavigationTreeByUser(userName, depth, includeGroups, dataFileState)
