...
namespace NRC.Common
{
    ...
    public class Logger
    {
        ...
        protected const string DEFAULT_LOG_DIR = @"C:\NRC\Logs\";
        ...
        {
            _eventClient = (eventCollectorUrl != null) ? new EventClient(eventCollectorUrl, a => _logger.Trace(a), (a, b) => _logger.ErrorException(a, b)) : null;
        }
        ...
        {
            CheckInitialization();
            _logger.InfoException(text, exception);
        }
        ...
        {
            CheckInitialization();
            _logger.ErrorException(text, exception);
            Event(null, "General.Error", new { }, new { });
        }
        ...
        public void Event(string id, string type, object intData, object stringData)
        {
            ...
            {
                _logger.ErrorException(String.Format("Unable to log event of type {0}: {1}", type, ex.Message), ex);
            }
        }
