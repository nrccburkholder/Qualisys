...
namespace Microsoft.Samples.AppUpdater
{
	...
	public class WebFileLoader
	{
		...
		private static void CopyStreamToDisk(Stream responseStream, String filePath)
		{
			...
			//Added by JCamp on 9/16/2004 so that files are created in the same folder
			//that they will be stored in so that the ACLs are correct.
			FileInfo file = new FileInfo(filePath);
			string tempPath = file.DirectoryName + "\\";
